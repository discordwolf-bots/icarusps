	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case ATTACK_NPC:
			...
			boolean usingCross = c.playerEquipment[c.playerWeapon] == 9185
					|| c.playerEquipment[c.playerWeapon] == 11785 || c.playerEquipment[c.playerWeapon] == 21012;
			...
			if ((c.usingBallista || usingOtherRangeWeapons || c.playerEquipment[c.playerWeapon] == 11907 || c.playerEquipment[c.playerWeapon] == 12899) && c.goodDistance(c.getX(), c.getY(), NPCHandler.npcs[c.npcIndex].getX(),
			...
			if (!c.getCombat().correctBowAndArrows() && Config.CORRECT_ARROWS && usingBow
					...
					&& c.playerEquipment[c.playerWeapon] != 9185 && c.playerEquipment[c.playerWeapon] != 11785 && c.playerEquipment[c.playerWeapon] != 21012 && c.playerEquipment[c.playerWeapon] != 19481 && c.playerEquipment[c.playerWeapon] != 19478) {
			...
			if (c.playerEquipment[c.playerWeapon] == 9185 && !c.getCombat().properBolts()
					|| c.playerEquipment[c.playerWeapon] == 11785 && !c.getCombat().properBolts() || c.playerEquipment[c.playerWeapon] == 21012 && !c.getCombat().properBolts()) {
			...
			//if (NPCHandler.npcs[c.npcIndex] != null) // NullPointerException
				//if (NPCHandler.npcs[c.npcIndex].npcType != Skotizo.AWAKENED_ALTAR_NORTH && NPCHandler.npcs[c.npcIndex].npcType != Skotizo.AWAKENED_ALTAR_SOUTH && NPCHandler.npcs[c.npcIndex].npcType != Skotizo.AWAKENED_ALTAR_WEST && NPCHandler.npcs[c.npcIndex].npcType != Skotizo.AWAKENED_ALTAR_EAST)
		...
		case MAGE_NPC:
			...
			if (c.usingMagic || c.playerEquipment[c.playerWeapon] == 11907 || c.playerEquipment[c.playerWeapon] == 12899) {
