	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		switch (packetType) {
			case FIRST_CLICK:
				...
				case 30283:
					...
					case 11701:
						...
						break;
					case 9398:// deposit
						c.getPA().sendFrame126("The Bank of Icarus - Deposit Box", 7421);
					...
					case 536://Smoke Devil Exit
						...
						break;
			/*case 17385://taveryly exit
				AgilityHandler.delayEmote(c, "CLIMB_UP", 1662, 3529, 0, 2);
				break;*/
					case 1738://tav entrance
						AgilityHandler.delayEmote(c, "CLIMB_DOWN", 2884, 9798, 0, 2);
						break;
					case 2123://relleka entrance
						AgilityHandler.delayFade(c, "CRAWL", 2808, 10002, 0, "You crawl into the entrance.", "and you end up in a dungeon.", 3);
					...
					case 2141://relleka exit
						...
						break;
					/*case 29734://dgorillas
						if (c.objectX == 1349 && c.objectY == 3591) {
							c.getPA().movePlayer(2130, 5646, 0);
							c.sendMessage("Welcome to the Demonic Gorilla's Dungeon, try your luck for a heavy frame!");
						}
						break;*/
					case 28687://dgexit
					...
					case 2823://mdragsentrance
						AgilityHandler.delayFade(c, "CRAWL", 1746, 5323, 0, "You crawl into the entrance.", "and you end up in a dungeon.", 3);
			...
			case SECOND_CLICK:
				...
				if (c.debugMessage) {
					c.sendMessage("Object Option Two: "+c.objectId+"  ObjectX: "+c.objectX+"  objectY: "+c.objectY+" Xoff: "+(c.getX()-c.objectX)+" Yoff: "
							              +(c.getY()-c.objectY));
				}
				switch (c.objectId) {
			...
			case THIRD_CLICK:
				...
				if (c.debugMessage) {
					c.sendMessage("Object Option Three: "+c.objectId+"  ObjectX: "+c.objectX+"  objectY: "+c.objectY+" Xoff: "+(c.getX()-c.objectX)+" Yoff: "
							              +(c.getY()-c.objectY));
				}
				if (c.objectId==12309) {
			...
			case FOURTH_CLICK:
				...
				if (c.debugMessage) {
					c.sendMessage("Object Option Four: "+c.objectId+"  ObjectX: "+c.objectX+"  objectY: "+c.objectY+" Xoff: "+(c.getX()-c.objectX)+" Yoff: "+(c.getY()-c.objectY));
				}
				switch (c.objectId) {
					default:
						c.objectDistance=1;
