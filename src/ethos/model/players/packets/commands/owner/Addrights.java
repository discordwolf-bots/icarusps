...
public class Addrights extends Command {
	...
	public void execute(Player c, String input) {
		...
		c.sendMessage("You have promoted " + args[0] + " to <col=ff0000><shad=000000>" + right.name() + "</shad></col>.");
		player.sendMessage("You have been promoted to <col=ff0000><shad=000000>" + right.name() + "</shad></col> by " + c.getName() + " .");
	}
