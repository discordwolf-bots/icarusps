...
public class Yell extends Command {
	...
	private String formatMessage(String title, String username, String color, int rights, String message) {
		...
		if (username.equalsIgnoreCase("Mod Sara")) {
			title = "Owner";
		} else if (username.equalsIgnoreCase("Mod Kabe")) {
			title = "Community Manager";
		}
		
		return "[<col=" + color + ">" + title + "</col>] <img=" + rights + "> " +username+ ": " + StringUtils.capitalize(message.toLowerCase());
	}
