...
public class FourOptions {
	...
	public static void handleOption1(Player c) {
		...
		if (c.dialogueAction == 136) {
			if (c.getPA().canTeleport("modern")) {
				...
				c.getPA().startTeleport(3103 + offset, 3933 + offset, 0, "modern");
			}
			return;
		}
		...
		{
			c.getPA().startTeleport(1504, 3419, 0, "glory");
	...
	public static void handleOption2(Player c) {
		...
		if (c.teleAction == 3) {
			c.getPA().spellTeleport(1189, 3501, 0);
		}
		if (c.dialogueAction == 2299) {
			c.playerXP[0] = c.getPA().getXPForLevel(99) + 5;
			c.playerLevel[0] = c.getPA().getLevelForXP(c.playerXP[0]);
		...
		if (c.usingSkills)  //c.getPA().useCharge();
		{
			c.getPA().startTeleport(1769, 3711, 0, "glory");
			c.getPA().useChargeSkills();
		}
		if (c.dialogueAction == 2) {
	...
	public static void handleOption3(Player c) {
		...
		if (c.teleAction == 13) {
			c.getPA().spellTeleport(2920, 5325, 2);
		}
		...
		if (c.teleAction == 3) {
			c.getPA().spellTeleport(1440, 3648, 0);
		}
		if (c.dialogueAction == 2299) {
			c.playerXP[0] = c.getPA().getXPForLevel(99) + 5;
			c.playerLevel[0] = c.getPA().getLevelForXP(c.playerXP[0]);
		...
		if (c.usingGlory) // c.getPA().useCharge();
		{
			c.getPA().startTeleport(Config.DRAYNOR_X, Config.DRAYNOR_Y, 0, "glory");
			c.getPA().useCharge();
		}
		if (c.usingSkills)  //c.getPA().useCharge();
		{
			c.getPA().startTeleport(1502, 3832, 0, "glory");
			c.getPA().useChargeSkills();
		}
		if (c.dialogueAction == 2) {
	...
	public static void handleOption4(Player c) {
		...
		case 1:
			...
			break;
		case 2:
			c.getPA().spellTeleport(2630, 5071, 0);
			return;
		}
		...
		if (c.teleAction == 3) {
			c.getPA().spellTeleport(2200, 3055, 0);
		}
		if (c.teleAction == 200) {
		...
		if (c.usingSkills)  //c.getPA().useCharge();
		{
			c.getPA().startTeleport(1721, 3464, 0, "glory");
			c.getPA().useChargeSkills();
		}
		if (c.dialogueAction == 2) {
