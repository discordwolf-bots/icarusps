...
public class FiveOptions {
	...
	public static void handleOption1(Player c) {
			...
			case 855: //Tekton
				...
				c.getPA().startTeleport(3309, 5277, 1, "modern");
		...
		case 141314:
			c.getPA().startTeleport(1271, 3556, 0, "modern");
		...
		if (c.teleAction == 15) { //Chickens
			c.getPA().spellTeleport(3236, 3295, 0);
		}
		if (c.teleAction == 99) { //Crash island
			c.getPA().spellTeleport(2897, 2725, 0);
		}
		if (c.teleAction == 1) { //Lava Dragons
			c.getPA().spellTeleport(2977, 3603, 0);
		} else if (c.teleAction == 2) { //Brimhaven Dungeon
			c.getPA().spellTeleport(1571, 3656, 0);
		} else if (c.teleAction == 200) { //Raids
			 c.getPA().spellTeleport(3301, 5192, 0);
		} else if (c.teleAction == 147258) { //Varrock
			 c.getPA().spellTeleport(3213, 3423, 0);
	...
	public static void handleOption2(Player c) {
		...
		case 855: //Skeletal mystics
			...
			c.getPA().startTeleport(3343, 5248, 1, "modern");
			c.getPA().closeAllWindows();
			break;
		...
		case 141314:
			c.getPA().startTeleport(1310, 3613, 0, "modern");
	...
	case 711:
		...
		if (c.teleAction == 1337) { //Skillers Cove
			c.getPA().spellTeleport(1721, 3464, 0);
			return;
		}
		...
		if (c.teleAction == 15) {
			c.getPA().startTeleport(3253, 3266, 0, "modern");
			return;
		}
		if (c.teleAction == 2) { //Taverly Dungeon
			c.getPA().spellTeleport(1662, 3529, 0);
		}
		if (c.teleAction == 33) { //Barrelchest
			c.getPA().spellTeleport(1229, 3497, 0);
		}
		if (c.teleAction == 3434) { //Venenatis
			c.getPA().spellTeleport(3339, 3756, 0);
		}
	...
	case 141314:
		c.getPA().startTeleport(1676, 3561, 0, "modern");
	...
	case 193193:
		...
		if (c.teleAction == 15) {
			c.getPA().startTeleport(1777, 3707, 0, "modern");
			return;
		}	
		if (c.teleAction == 99) {
				c.getPA().startTeleport(3429, 3537, 0, "modern");
				return;
			}
		if (c.teleAction == 99) {
		...
		if (c.teleAction == 1) {
			...
			c.getPA().spellTeleport(2480, 5175, 0);
			 ...
			 c.getPA().spellTeleport(3432, 3451, 0);
		} else if (c.teleAction == 4) {
			// Hillz
	...
	public static void handleOption4(Player c) {
		...
		case 711:
			...
			break;
		case 141314:
			c.getPA().startTeleport(1495, 3555, 0, "modern");
	...
	public static void handleOption5(Player c) {
		...
		case 141314:
			c.getPA().startTeleport(1821, 3688, 0, "modern");
		...
		if (c.teleAction == 15) { //Terrorbirds
			...
			c.getDH().sendDialogues(121313, -1); 
			 ...
			 c.getPA().spellTeleport(2673, 3709, 0);
		} else if (c.teleAction == 3434) { //Fnatic
			c.getPA().spellTeleport(2993, 3854, 0);
			...
			c.getPA().spellTeleport(3029, 9582, 0);
		}
		if (c.teleAction == 1) {
