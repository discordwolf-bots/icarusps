...
public class Farming {
	...
	public void handleCompostRemoval() {
		if (!player.getItems().playerHasItem(FarmingConstants.BUCKET)) {
			...
			if(compostTotal == 1) player.sendMessage("You have filled a bucket of compost.");
			if(compostTotal > 1) player.sendMessage("You have filled "+compostTotal+" buckets of compost.");
...
/*				if (id >= 4 && player.amountDonated < 150) {
	...
	enum Patch {
		...
		DONATOR21(20, 3003, 3374),
		DONATOR22(21, 3005, 3374),
		DONATOR23(22, 3003, 3372),
		DONATOR24(23, 3005, 3372);
