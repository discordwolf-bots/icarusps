...
public class GlassData {
	...
	FISHBOWL(new int[][] {{24059, 1}, {24058, 5}, {24057, 10}, {24056, 28}}, 6667, 1, 42, 50),
	GLASS_ORB(new int[][] {{48108, 1}, {48107, 5}, {48106, 10}, {44211, 28}}, 567, 1, 46, 75),
	BULLSEYE_LANTERN_LENS(new int[][] {{48124, 1}, {48123, 5}, {48122, 10}, {48121, 28}}, 4542, 1, 49, 100);
