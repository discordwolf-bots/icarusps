...
public class CraftingData extends SkillHandler {
	...
	public static enum battlestaveData {
		...
		AIR(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 14 } }, 573, 1397, 66, 250, 1),
		FIRE(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 14 } }, 569, 1393, 62, 195, 1),
		EARTH(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 14 } }, 575, 1399, 58, 200, 1),
		WATER(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 14 } }, 571, 1395, 54, 200, 1);
	...
	public static enum leatherData {
		...
		LEATHER_VAMBRACES(new int[][] { { 33196, 1 }, { 33195, 5 }, { 33194, 10 } }, 1741, 1063, 11, 22, 1), 
		...
		SNAKESKIN_BODY(new int[][] { { 34245, 1 }, { 34244, 5 }, { 34243, 10 }, { 34242, 28 } }, 6289, 6322, 53, 150, 15), 
		SNAKESKIN_CHAPS(new int[][] { { 34249, 1 }, { 34248, 5 }, { 34247, 10 }, { 34246, 28 } }, 6289, 6324, 51, 140, 12), 
		SNAKESKIN_BANDANA(new int[][] { { 34253, 1 }, { 34252, 5 }, { 34251, 10 }, { 34250, 28 } }, 6289, 6326, 48, 145, 5), 
		SNAKESKIN_BOOTS(new int[][] { { 35001, 1 }, { 35000, 5 }, { 34255, 10 }, { 34254, 28 } }, 6289, 6328, 45, 170, 6), 
		SNAKESKIN_VAMBRACES(new int[][] { { 35005, 1 }, { 35004, 5 }, { 35003, 10 }, { 35002, 28 } }, 6289, 6330, 47, 190, 8), 
		GREEN_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 }, { 34183, 10 }, { 34182, 28 } }, 1745, 1065, 57, 110, 1), 
		GREEN_DHIDE_BODY(new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 }, { 34190, 28 } }, 1745, 1135, 63, 185, 3), 
		GREEN_DHIDE_CHAPS(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 28 } }, 1745, 1099, 60, 190, 2), 
		BLUE_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 }, { 34183, 10 }, { 34182, 28 } }, 2505, 2487, 66, 179, 1), 
		BLUE_DHIDE_BODY(new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 }, { 34190, 28 } }, 2505, 2499, 71, 235, 3), 
		BLUE_DHIDE_CHAPS(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 28 } }, 2505, 2493, 68, 250, 2), 
		RED_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 }, { 34183, 10 }, { 34182, 28 } }, 2507, 2489, 73, 150, 1), 
		RED_DHIDE_BODY(new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 }, { 34190, 28 } }, 2507, 2501, 77, 234, 3), 
		RED_DHIDE_CHAPS(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 28 } }, 2507, 2495, 75, 240, 2), 
		BLACK_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 }, { 34183, 10 }, { 34182, 28 } }, 2509, 2491, 79, 250, 1), 
		BLACK_DHIDE_BODY(new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 }, { 34190, 28 } }, 2509, 2503, 84, 280, 3), 
		BLACK_DHIDE_CHAPS(new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 }, { 34186, 28 } }, 2509, 2497, 82, 300, 2);
