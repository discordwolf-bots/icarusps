...
public class Smithing {
	...
	private static void CheckAddy(final Player c, final int level, final int amounttomake, final String type) {
		...
		if(amounttomake == -1) {
			maketimes = c.getItems().getItemAmount(remove) / removeamount;
		}
	...
	private static void CheckMith(final Player c, final int level, int amounttomake, final String type) {
		remove = 2359;
	...
	private static void CheckRune(final Player c, final int level, int amounttomake, final String type) {
		remove = 2363;
	...
	private static void CheckSteel(final Player c, final int level, int amounttomake, final String type) {
		remove = 2353;
		...
		if(amounttomake == -1) {
			amounttomake = c.getItems().getItemAmount(remove) / removeamount;
		}
