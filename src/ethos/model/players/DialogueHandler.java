...
public class DialogueHandler {
	 ...
	 */
	public final int HAPPY = 588, CALM = 589, CALM_CONTINUED = 590, CONTENT = 591, EVIL = 592, EVIL_CONTINUED = 593, DELIGHTED_EVIL = 594, ANNOYED = 595, DISTRESSED = 596,
			DISTRESSED_CONTINUED = 597, NEAR_TEARS = 598, SAD = 599, DISORIENTED_LEFT = 600, DISORIENTED_RIGHT = 601, UNINTERESTED = 602, SLEEPY = 603, PLAIN_EVIL = 604,
			LAUGHING = 605, LONGER_LAUGHING = 606, LONGER_LAUGHING_2 = 607, LAUGHING_2 = 608, EVIL_LAUGH_SHORT = 609, SLIGHTLY_SAD = 610, VERY_SAD = 611, OTHER = 612,
			NEAR_TEARS_2 = 613, ANGRY_1 = 614, ANGRY_2 = 615, ANGRY_3 = 616, ANGRY_4 = 617;
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 851:
			sendOption5("Teleport me to the raids dungeon", "Can I see the raids shop?", "What is this place?", "Is this safe?", "I don't need any help");
			c.dialogueAction = 851;
			break;
			//What is this?
		case 852:
			sendNpcChat("I am here to show and bring you to the deep dungeons", "called raids, whereas you can put your strength to the test", "and combat mighty foes for rewards", "you've always been looking for!");
			c.nextChat = 851;
			break;
			//Is this safe?
		case 853:
			sendNpcChat("@red@NO!", "Raids dungeons are not safe, be aware and join only", "if you are willing to risk what you bring!");
			c.nextChat = 851;
			break;
			//Teleport me to
		case 854:
		...
		case 800:
			...
			break;
		case 801:
			sendOption5("What is this?", "I would like to " + (c.inClanWars() || c.inClanWarsSafe() ? "go back to reality." : "go to pk district.") + "", "How do I transfer my blood money?", "I would like to view my safe-box", "Nevermind..");
			c.dialogueAction = 801;
			break;
			//What is this?
		case 802:
			sendNpcChat("I am in charge of the PK-District, whereas I invite you", "to challenge players individually or in team", "you are able to earn blood money while", "being within the pk-district.");
			c.nextChat = 803;
			break;
		case 803:
			sendNpcChat("You are then able to use your earned blood money", "in my shop for various items.", "While entering the pk-district, your stats will be set", "to 99. Don't freak out, it will be back to normal if you leave.");
			c.nextChat = 804;
			break;
		case 804:
			sendNpcChat("You can not bring any items into the district", "And to transfer back your blood money to reality, simply", "deposit them into your safe-box!");
			c.nextChat = 801;
			break;
			//I would like to..
		case 805:
			...
			if (c.getItems().isWearingItems() || c.getItems().freeSlots() < 28 && c.inClanWarsSafe()) {
				sendNpcChat("The items you are currently wearing and carrying will be lost", "Are you sure you want to do this?");
				c.nextChat = 813;
				return;
			}
			...
			//Deposit/withdraw
		case 806:
			sendNpcChat("To transfer your blood money from district to reality", "or vice versa, Simply deposit your blood money into", "your safe-box and withdraw them where you want them.");
			c.nextChat = 801;
			break;
		case 812:
		...
		case 813:
			...
			//Safe box
		case 818:
			sendNpcChat("Using quick-sets will replace your inventory and worn items", "You have been warned!!", "@red@Deposit your valuable items/blood money.");
			c.nextChat = 819;
			break;
		case 819:
		...
		case 193193:
			sendOption5("<col=#285f5c><shad=000000>Piscarlarius House</shad></col>", "<col=#316319><shad=000000>Hosidius House</shad></col>", "<col=#612421><shad=000000>Shayzien House</shad></col>", "<col=#774229><shad=000000>Mount Quidamortem</shad></col>", "<col=#544656><shad=000000>Arceuus House</shad></col>");
		...
		case 785:
			sendPlayerChat2("Hmm.. It says here my item donations", "will only count towards @red@Double XP@bla@. &$#@.");
			c.nextChat = 786;
			break;
		...
		case 720:
			...
			break;
		case 721:
			sendNpcChat("Why hello there " + c.playerName + ", welcome to your worst nightmare!", "I am here to offer you some pieces of clothing", "In exchange for a piece of your brain!");
			c.nextChat = 722;
			break;
		case 722:
			sendNpcChat("Jokes aside (MWUHAHAH)", "I have gathered some items from slain players and placed", "them on the ground here.", "I want you to guess, in which order I placed them down!");
			c.nextChat = 723;
			break;
		case 723:
			sendNpcChat("You must select the order by clicking on each item", "When you have done so, come back to me and I will correct it", "for you, if you get them all right", "There will be a reward waiting for you!");
			c.nextChat = 724;
			break;
		case 724:
			sendNpcChat("If you do not, then you must start OVER!#", "You will be here for a while!", "MWUHAHAHAHAHA!", "Now go ahead freaky..");
		...
		case 727:
			...
			break;
		case 728:
			sendNpcChat("HAHAHAH, you did NOT get them all right!", "Check your chatbox for a list of your chosen order", "Your order will remain the same until", "you actually manage to get them all right!");
			c.nextChat = -1;
			break;
		case 729:
		...
		case 704:
			sendNpcChat("Alright, that will be 500K coins and 5 vote points thank you.", "You must have the visage and a antifire shield as well", "of course.");
			c.nextChat = 705;
			break;
		...
		case 706:
			if (c.getItems().playerHasItem(11286) && c.getItems().playerHasItem(1540) && c.getItems().playerHasItem(995, 500_000) && c.votePoints >= 5) {
		...
		case 701:
			...
			if (c.getItems().playerHasItem(13273)) {
				...
				PlayerHandler.executeGlobalMessage("@red@[Lootations]@cr19@ <col=255><img="+rights+">" + Misc.formatPlayerName(c.playerName) + "</col> received @blu@1@bla@x @blu@" + Item.getItemName(reward) + ".");
				sendItemStatement("The Font consumed the Unsired and returns you a \\n reward.", UNSIRED_REWARDS[randomReward]);
			}
			c.nextChat = -1;
			break;
		...
		case 67:
			sendNpcChat("Nice banner you got there, "+ c.playerName +"!", "Since you do have one I will offer to take your crystal", "And a price of 25M coins to create", "A Crystal Halberd, just for you!");
			c.nextChat = 66;
			break;
		...
		case 110:
			...
			sendNpcChat(Boundary.entitiesInArea(Boundary.BOSS_ROOM_WEST) +" " + (Boundary.entitiesInArea(Boundary.BOSS_ROOM_WEST) == 1 ? "adventurer is" : "adventurers are") + " inside the cave.");
//			if (c.absX < 1296) { //West
//				sendNpcChat(Boundary.entitiesInArea(Boundary.BOSS_ROOM_WEST) +" " + (Boundary.entitiesInArea(Boundary.BOSS_ROOM_WEST) == 1 ? "adventurer is" : "adventurers are") + "  inside the cave.");
//			} else if (c.absX > 1325) { //East
//				sendNpcChat(Boundary.entitiesInArea(Boundary.BOSS_ROOM_EAST) +" " + (Boundary.entitiesInArea(Boundary.BOSS_ROOM_EAST) == 1 ? "adventurer is" : "adventurers are") + " inside the cave.");
//			} else if (c.absX > 1265) { //North
//				sendNpcChat(Boundary.entitiesInArea(Boundary.BOSS_ROOM_NORTH) +" " + (Boundary.entitiesInArea(Boundary.BOSS_ROOM_NORTH) == 1 ? "adventurer is" : "adventurers are") + " inside the cave.");
//			}
			break;
		...
		case 76:
			...
			break;
		case 77:
			sendOption5("Toggle ROL Effect", "Toggle Fishing Effect", "Toggle Mining Effect", "Toggle Woodcutting Effect", "Nevermind..");
			c.dialogueAction = 77;
			break;
		case 78:
		...
		case 90:
			...
			//OSRS Donating
		case 11929:
			sendNpcChat3("Hello "+c.playerName+" I am the OSRS GP Donation Manager.", "If you are interested in donating, contact Mod Sara.", "Donate to anyone else you will be perm banned!", 3189, "GP Donation Manager");
			c.nextChat = 11930;
			break;
		 ...
		 */
		case 62:
			sendNpcChat3(Misc.capitalize(c.playerName) + " I must warn you, inside that dimension you will", "have no assistance from the gods, and your prayers will",
					"not work at all!", 4847, "Gypsy");
			c.nextChat = 59;
			break;
		...
		case 59:
			sendNpcChat4("Also be aware that he will use his powers to draw upon", "the might of foes you have not fought before, and",
					"that dimensional instability means that your lost items", "will be irretrievable should you die...", 4847, "Gypsy");
			c.nextChat = 60;
			break;
		...
		case 63:
			sendOption5("Resource Area @bla@(@red@Wilderness@bla@) 60K Coins.", "KBD Lair @bla@25K Coins.", "Godwars Dungeon + 10 KC @bla@80K Coins.", "Corporeal Beast Lair @bla@100K Coins", "");
			c.dialogueAction = 61;
			break;
			
//		case 64:
//			sendOption5("Resource Area @bla@(@red@Wilderness@bla@) 60K Coins.", "KBD Lair @bla@25K Coins.", "Godwars Dungeon + 10 KC @bla@80K Coins.", "", "Previous Page");
//			c.dialogueAction = 61;
//			break;
		...
		case 1427:
			sendNpcChat4("I am Ak-Haranu and I'm in charge of Prestiging.", "Prestiging lets players set the skill back to", "level one in order to gain prestige points.", "You can then buy perks with the points.", 2989, "Ak-Haranu");
			c.nextChat = 1428;
			break;
		case 1428:// Prestige
		...
		case 947:
			...
			break;
		case 3299:
			sendNpcChat("Before I assign you anything, I want to make", "something clear. My tasks have to be done in the",
		...
		case 3300:
			if (c.getSlayer().getTask().isPresent()) {
				if (c.getSlayer().getTask().get().getLevel() > c.playerLevel[Skill.SLAYER.getId()]) {
					sendNpcChat("You have been assigned a task you cannot complete.", "What an inconvenience, i'll get to the bottom of this.",
							"In the meanwhile, i've reset your task.", "Talk to me or one of the others to get a new task.");
		...
		case 149:
			...
			break;
		case 3301:
			sendOption4("I'd like to see the slayer interface.", "I am in need of a slayer assignment.", "Could you tell me where I can find my current task?", "Nothing, sorry!");
			c.dialogueAction = 3301;
			break;
		case 3325:
			c.getDH().sendOption5("KBD Entrance @red@(DEEP WILD)", "Chaos Elemental @red@(DEEP WILD)", "Godwars", "Barrelchest @red@(Lvl 20+ Wild)", "@blu@Next");
			c.teleAction = 3;
			c.dialogueAction = -1;
			break;
		case 3324:
			...
			if (task.isPresent() && master.isPresent() && myMaster.isPresent()) {
				if (c.getSlayer().getMaster() != master.get().getId()) {
					if (myMaster.get().getLevel() < master.get().getLevel()) {
						sendNpcChat("You have an easier task from a different master.", "If you cannot complete their task, you cannot start",
								"one of mine. You must finish theirs first.");
						c.nextChat = -1;
						return;
					}
					sendNpcChat("I can give you an easier task but this will reset your", "consecutive tasks completed if you have an active task.", "Are you sure this is what you want to do?");
					c.nextChat = 3308;
				} else {
					if (c.talkingNpc == 401) {
						sendNpcChat("You currently have " + c.getSlayer().getTaskAmount() + " " + c.getSlayer().getTask().get().getPrimaryName() + " to kill.",
								"You cannot get an easier task. You must finish this.");
						c.nextChat = -1;
					} else if (c.talkingNpc == 402) {
						sendNpcChat("You currently have " + c.getSlayer().getTaskAmount() + " " + c.getSlayer().getTask().get().getPrimaryName() + " to kill.",
								"Talk to Turael for an easier task. If you", "obtain an easier task your consecutive tasks will be reset.");
						c.nextChat = -1;
		...
		case 55864:
			sendNpcChat2("Welcome to the Shayzien House!", "Home of the best soldiers in the entire WORLD!", c.talkingNpc, "Shayzien Guard");
			c.nextChat = 0;
			break;
		case 55865:
			sendNpcChat2("You don't seem like a warrior to me...", "You'd be better off at the Hosidius House, HAHA!", c.talkingNpc, "Shayzien Guard");
			c.nextChat = 0;
			break;
		case 55866:
			sendNpcChat2("I hear the Piscarilius House has some", "interesting fish to be caught.", c.talkingNpc, "Shayzien Guard");
			c.nextChat = 0;
			break;
			
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.", "Interested in becoming an Icarus <img=4>@red@Donator@bla@?", "Go to the bottom of your quest tab and click the <img=19>@yel@Store.", c.talkingNpc, "<img=4>Donation Informative<img=4>");
			c.nextChat = 0;
			break;
			
		case 5999:
			sendNpcChat3("Welcome to the <img=4>@red@Donator Zone.", "If you want to get inside,", "All you need to do is type ::dz .", c.talkingNpc, "<img=4>Donation Informative<img=4>");
			c.nextChat = 0;
			break;
			
		case 55867:
			sendNpcChat2("I've heard rumors about wilderness skilling.", "I haven't ventured far enough north to find it.", c.talkingNpc, "Shayzien Guard");
			c.nextChat = 0;
			break;
			
		case 55868:
			sendNpcChat2("I found some adamant ore in the mine here.", "I sold is for a pint of ale!", c.talkingNpc, "Old Sailor");
			c.nextChat = 0;
			break;
		case 55869:
			sendNpcChat2("I hate working here... One day,", "I'll travel to Lands End and become a crafting master!", c.talkingNpc, "Port Worker");
			c.nextChat = 0;
			break;
		case 55870:
			sendNpcChat2("If you're looking to catch Karambwans,", "You've come to the right place!", c.talkingNpc, "Port Officer");
			c.nextChat = 0;
			break;
		case 55871:
			sendNpcChat2("We were sailing next to CrabClaw Isle..", "When out of nowhere, a Kraken attacked!", c.talkingNpc, "Port Officer");
			c.nextChat = 0;
			break;
		case 55872:
			sendNpcChat2("I ain't never going back to that old farm!", "I'm *burp* happy right here!", c.talkingNpc, "Drunk Farmer");
			c.nextChat = 0;
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Matt to be a travelling banker!", c.talkingNpc, "Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
			sendNpcChat2("Welcome to my chapel.", "Feel free to train your prayer skill here.", c.talkingNpc, "High Priest");
			c.nextChat = 0;
			break;
		case 55876:
			...
			break;
		case 55877:
			sendNpcChat2("Those lizards are no joke!", "I wish I had some better armor...", c.talkingNpc, "Injured Guard");
			c.nextChat = 0;
			break;
		case 55874:
			sendOption5("Mount Quidamortem", "Xeric's Shrine", "Hosidius House", "Graveyard of Heros", "Piscarilius Docks");
		...
		case 1393:
			sendOption5("Set Value to 100K", "Set Value to 500K", "Set Value to 1M", "Set Value Manually", "What is this?");
			c.dialogueAction = 1393;
			break;
			
		case 1394:
			sendNpcChat("By configuring your dropvalue you are able", "to set it at any amount and when enabled", "any drop you receive which is worth that amount", "or more will be noticed by a graphic on the ground.");
			c.nextChat = 1393;
			break;
		...
		case 1400:
			...
			break;
		case 1401:
			sendOption5("Reset Attack", "Reset Strength", "Reset Defence", "Next", "I do not want to reset a stat right now");
		...
		case 14400:
			sendNpcChat("Hello there, "+c.playerName+".", "I can take you to the agility courses or", "sell you some clothing.");
			c.nextChat = 14401;
			break;
		case 14401:
		...
		case 14001:
			...
			break;
		case 14002:
			sendNpcChat2("And I like my humans crispy.", "You'll regret keeping me prisoner.", c.talkingNpc, "Dagganoth Rex Jr");
			c.nextChat = 0;
			break;
		case 14003:
		...
		case 14005:
			...
			break;
		case 14006:
			sendNpcChat2("ARE YOU NOT ENTERTAINED?", "IS THIS NOT WHY YOU ARE HERE?", c.talkingNpc, "Dagganoth Prime Jr");
			c.nextChat = 14007;
			break;
		case 14007:
		...
		case 14008:
			...
			break;
		case 14009:
			sendNpcChat2("...and then she mentioned something called a BBC?", "Oh, err, hello human.", c.talkingNpc, "King Black Dragon Jr");
			c.nextChat = 14010;
			break;
		case 14010:
		...
		case 14011:
			...
			break;
		case 14012:
			sendPlayerChat3("Yeah! I've never seen one before.", "I guess it's one small step for NPC's,", "one giant leap for Icarus!");
			c.nextChat = 14013;
			break;
		case 14013:
			sendNpcChat1("Precisely. Talk to you later, Neil! Err..." + c.playerName + "", c.talkingNpc, "Barrelchest Jr");
			c.nextChat = 0;
			break;
		case 14014:
			sendNpcChat3("I have failed my master on Gielinor.", "The Allspark has been...", "Human! what do you want!", c.talkingNpc, "General Graardor Jr");
			c.nextChat = 14015;
			break;
		case 14015:
			...
			break;
		case 14016:
			sendNpcChat2("PUNY but smart Human!", "You know to fear Graardor, leader of the Jogres.", c.talkingNpc, "General Graardor Jr");
			c.nextChat = 0;
			break;
		case 12001:
		...
		case 2400:
			sendOption5("Imbue Berserker Ring - @red@250 PKP", "Imbue Archer Ring - @red@250 PKP", "Imbue Seers Ring - @red@250 PKP", "Imbue Warrior Ring - @red@250 PKP", "More");
			c.dialogueAction = 114;
			c.teleAction = -1;
			c.nextChat = 0;
			break;
		case 2401:
			c.getDH().sendNpcChat2("Hello. I can take one of your regular rings", "and imbue it for PK points (PKP).", c.talkingNpc, "Amik Varze");
			c.nextChat = 2400;
			break;

		case 2402:
			sendOption5("Imbue Treasonous Ring @red@250 PKP", "Imbue Tyrannical Ring @red@250 PKP", "", "Previous", "Close");
			c.dialogueAction = 135;
			break;
		case 2603:
			c.getDH().sendNpcChat2("Hello. I can restore your HP if you", "are a donator or higher!", c.talkingNpc, "A'abla");
			c.nextChat = 0;
			break;
		case 9994:
		...
		case 1023:
			...
			break;
		case 2245:
			c.getDH().sendOption3("Teleport me to Lunar Island, for lunars spellbook!", "Teleport me to Desert Pyramid, for ancients spellbook!", "No thanks, i will stay here.");
		...
		case 69:
			...
			break;
		case 6969:
			c.getDH().sendNpcChat2("I'm not working right now sir.", "If you wan't me to work, talk to Ardi give me a job.", c.talkingNpc, "Unemployed");
			c.sendMessage("This NPC do not have an action, if you have any suggestion for this NPC, post on forums.");
			c.nextChat = 0;
			break;
		/* LOGIN 1st TIME */
		case 769:
			c.getDH().sendNpcChat2("Welcome to Nothing!", "You must select your starter package.", c.talkingNpc, "Guide");
			c.nextChat = 770;
			break;
		case 770:
		...
		/* END LOGIN */
		case 691:
			c.getDH().sendNpcChat2("Welcome to 2007remake.", "Please, read what i've to tell you...", c.talkingNpc, "Mod Ardi");
			c.nextChat = 692;
			// c.loggedIn = 1;
			break;
		case 692:
			sendNpcChat4("2007remake's on pre-alpha state.", "Then you can spawn items, and set your levels.", "But remember, it's just for pre-alpha sir...",
					"When we do the official release...", c.talkingNpc, "Mod Ardi");
			c.nextChat = 693;
			break;
		case 693:
			sendNpcChat4("We will have economy reset and,", "this commands will be removed too...", "Please, report glitches, and post suggestions",
		...
		/*
		 * case 1023: c.getDH().sendNpcChat1( "You must pay a toll of 10 gold coins to pass.", c.talkingNpc, "Border Guard"); c.nextChat = 1024; break;
		 */
		case 1024:
		...
		case 1014:// bank open done, this place done, settings done, to do
					// delete pin
			c.getDH().sendOption3("I'd like to access my bank account, please.", "I'd like to check my my P I N settings.", "What is this place?");
		...
		case 1015:
			...
			break;
		case 1016:
			c.getDH().sendNpcChat2("This is the bank of 2007remake.", "We have many branches in many towns.", c.talkingNpc, "Banker");
			c.nextChat = 0;
			break;
		/*
		...
		case 1017:
			c.getDH().sendStartInfo("Since you don't know your P I N, it will be deleted in @red@3 days@bla@. If you",
					"wish to cancel this change, you may do so by entering your P I N", "correctly next time you attempt to use your bank.", "", "", false);
			c.nextChat = 0;
			break;
		case 0:
			c.talkingNpc = -1;
		...
		case 5:
			...
			break;
		case 6:
			sendNpcChat4("The way the game works is as follows...", "You will be teleported to the wilderness,", "You must kill mages to receive points,",
					"redeem points with the chamber guardian.", c.talkingNpc, "Kolodion");
			c.nextChat = 15;
			break;
		case 11:
			sendNpcChat4("Hello!", "My name is Duradel and I am a master of the slayer skill.", "I can assign you a slayer task suitable to your combat level.",
		...
		case 23000:
			c.getDH().sendStartInfo("As you collect your reward, you notice an awful smell.", "You look below the remaining debris to the bottom of the",
					"chest. You see a trapdoor. You open it and it leads to a ladder", "that goes down a long ways.", "Continue?");
			break;
		case 24000:
		...
		case 206:
			...
			break;
		case 23:
			sendNpcChat4("Greetings, Adventure", "I'm the legendary Vesta seller", "With 120 noted Lime Stones, and 20 Million GP", "I'll be selling you the Vesta's Spear",
		...
		case 29:
			...
			break;
		case 30:
			sendNpcChat4("Congratulations!", "You have defeated all Recipe for Disaster bosses", "and have now gained access to the Culinaromancer's chest",
					"and the Culinaromancer's item store.", c.talkingNpc, "Sir Amik Varze");
			c.nextChat = 0;
		...
		case 146:
			sendNpcChat3("Right click me and use the 'Exchange' option", "to turn your Blood Money into points", "to use in my shop!", c.talkingNpc, "Blood Money Exchange");
			c.nextChat = 0;
			break;
		...
		case 511:
			sendNpcChat3("I lost a large amount of @or2@pumpkins@bla@.", "I was travelling through the wilderness and they were stolen.",
		...
		case 514:
			sendNpcChat4("Every Halloween I travel through the wilderness", "carrying a very important bag of pumpkins.", "I need to take these pumpkins to the other world",
		...
		case 519:
			sendNpcChat3("You fool, these are no ordinary pumpkins.", "They are the root of my power, without them I cannot", "venture to this world. Thus, no more halloween.",
					c.talkingNpc, "Grim Reaper");
			c.nextChat = 520;
			break;

		case 520:
			sendPlayerChat3("No more halloween, that would be no more candy.", "That would also mean no more grim reaper.",
		...
		case 524:
			sendNpcChat3("You will need to recover @red@50@bla@ pumpkins..", "You can find these pumpkins in a chest, in the wilderness.", "The chest is guarded by four ghosts.",
					c.talkingNpc, "Grim Reaper");
			c.nextChat = 525;
			break;
		...
		case 525:
			...
			sendNpcChat4("Although they are not tough, they move quickly.", "They move from location to location every 10 minutes.",
					"You will need to be quick, I have something to help.", "Here, take this locating crystal to find them.", c.talkingNpc, "Grim Reaper");
			c.nextChat = 526;
			break;
		...
		case 527:
			...
			sendNpcChat3("Activating this crystal will let you know", "how far you are from the chest and in which", "direction it lies in. Move along, be quick.", c.talkingNpc,
					"Grim Reaper");
			c.nextChat = -1;
			break;
		...
		case 528:
			if (!c.getItems().playerHasItem(611) && !c.getItems().bankContains(611)) {
				...
				sendNpcChat3("You are fortunate, I found the crystal.", "Do not lose this crystal again, it's important.", "Come talk to me when you have made some progress.",
						c.talkingNpc, "Grim Reaper");
				c.getItems().addItem(611, 1);
				c.nextChat = -1;
			} else {
		...
		case 529:
			...
			if (total < 50) {
				if (total == 0) {
					sendNpcChat3("You have not found any pumpkins.", "You need to look harder and search using the locator.", "Hurry, there isn't much time.", c.talkingNpc,
							"Grim Reaper");
				} else if (total > 0 && total < 10) {
					sendNpcChat3("You have found " + total + ", that's a good start.", "However, you need to search harder.", "Hurry, there isn't much time.", c.talkingNpc,
							"Grim Reaper");
				} else {
		...
		case 533:
			sendNpcChat3("You came through for me human, halloween will", "continue to exist because of you.", "I hope you enjoy the reward I gave you.", c.talkingNpc,
					"Grim Reaper");
			c.nextChat = 534;
			break;
		...
		case 536:
			if (c.getHolidayStages().getStage("Halloween") >= 6) {
				sendNpcChat3("There is nothing left to do, you already found", "the hood I was keeping from you.", "Enjoy your holiday " + c.playerName + ".", c.talkingNpc,
						"Grim Reaper");
				c.nextChat = -1;
			} else {
				sendNpcChat4("Since you helped me retrieve my pumpkins, i'll let", "you in on a secret I've been keeping from you.",
						"Search the crate and find the @or2@Grim Reaper Hood@bla@.", "There is only one in the crate.", c.talkingNpc, "Grim Reaper");
				c.nextChat = -1;
			}
			break;
		...
		case 537:
			if (c.getItems().bankContains(611)) {
				sendNpcChat3("Hmm...It seems your bank has the locator in it.", "You may have helped me but I will still punish you.",
						"I will provide you with one if you don't have one.", c.talkingNpc, "Grim Reaper");
				c.nextChat = -1;
				return;
			}
			if (c.getItems().playerHasItem(611)) {
				sendNpcChat3("Hmm...It seems your inventory has the locator in it.", "You may have helped me but I will still punish you.",
						"I will provide you with one if you don't have one.", c.talkingNpc, "Grim Reaper");
				c.nextChat = -1;
				return;
			}
		...
		case 551:
			sendNpcChat3("There are currently " + Boundary.entitiesInArea(Boundary.WILDERNESS) + " players in wilderness.", "There are currently " + Boundary.entitiesInArea(Boundary.WILDERNESS_UNDERGROUND) + " players in underground wilderness.", "There are currently " + Boundary.entitiesInArea(Boundary.WILDERNESS_GOD_WARS_BOUNDARY) + " players in godwars wilderness.", c.talkingNpc, "Emblem Trader");
			c.nextChat = 0;
			break;
		...
		case 553:
			sendNpcChat2("I see you have something valuable on your person.", "Certain.... ancient emblems, you see.", c.talkingNpc, "Emblem Trader");
			c.nextChat = 554;
			break;
		...
		case 555:
			sendStatement("All of your emblems are worth a total of " + Misc.insertCommas(Integer.toString(c.getBH().getNetworthForEmblems())), "Bounty points.");
			c.nextChat = 556;
			break;
		...
		case 579:
			...
			//Eric Hunter
		case 88393:
			sendNpcChat2("I've been looking for Red Chinchompas...", "I hear they are to the North West of here.", c.talkingNpc, "Hunting Expert");
			c.nextChat = -1;
			break;
		case 88394:
			sendNpcChat2("Birds surround this area, you should start with those.", "After that, you can hunt larger animals.", c.talkingNpc, "Hunting Expert");
			c.nextChat = -1;
			break;
		...
		case 582:
			sendNpcChat("Strange, another player asked the same thing.", "The reason I am here in edgeville is is because", "I am looking for people with good hearts to help me.",
		...
		case 584:
			sendNpcChat("Ho Ho Ho, aren't you a little rascal.", "I hope you like smithing because you will", "be getting tons of coal this year.");
			c.nextChat = -1;
			break;
		...
		case 591:
			sendNpcChat("The only choice we have is to go by foot and go", "from station-to-station which is very tedious for our little elves.");
			c.nextChat = 592;
			break;

		case 592:
			sendNpcChat("I need you to go from station-to-station to further", "the development of each toy. Let me explain the process.",
					"Each toy has 2 stages of development. The first is", "the development stage, this happens at @blu@Station #1@bla@.");
			c.nextChat = 593;
			break;
		...
		case 594:
			sendNpcChat("You must bring each toy to station 1, and station 2.", "You cannot take a toy to station 2, then station 1.",
					"If you do, the toy may break and you will have to restart.");
			c.nextChat = 595;
			break;

		case 595:
			sendNpcChat("Each station will have a unique engineer.", "You must give the toy to the engineer at that station.", "Once the engineer at station 2 has finished the",
		...
		case 599:
			...
			sendNpcChat("You must take this item to each station.", "If you need directions, talk to me again.", "I will give you the next toy when you return with",
					"the fully developed toy.");
			c.nextChat = -1;
			c.dialogueAction = -1;
			break;
		...
		case 602:
			sendNpcChat("The first station is at the top of the ice-path.", "Right-click on me to go there", "Note: It is very cold and slippery, you might take damage.");
			c.nextChat = 603;
			break;
		...
		case 604:
			...
			if (!c.getItems().playerHasItem(toyId)) {
				sendNpcChat("Hello there, you should get a toy", "from santa and come back.", "Or talk to the other engineer in station 2 if",
						"you already have the developed toy.");
				c.nextChat = -1;
				return;
			}
			...
			c.nextChat = -1;
			CycleEventHandler.getSingleton().addEvent(CycleEventHandler.Event.CHRISTMAS_ENGINEER, c, new ChristmasToyUpgrade(c, toyId, c.talkingNpc), 10);
			break;
		...
		case 606:
			sendNpcChat("The toy has been further developed and is now", "ready to be completed. Go to the second", "station and talk to the other engineer.");
			c.dialogueAction = -1;
			c.nextChat = -1;
			break;
		...
		case 609:
			...
			if (!nextToy.isPresent()) {
				...
				sendNpcChat("Thank you for helping me.", "I have given you a @blu@Reindeer Hat@bla@", "for your time, it's the least I can do.");
				c.nextChat = -1;
				return;
			}
			stage++;
		...
		case 610:
			sendNpcChat("I cannot thank you enough for the help " + Misc.capitalize(c.playerName) + ".", "Would you like to fight the anti-santa? You must",
		...
		case 613:
			sendOption5("How much have I contributed this week?", "Who are the top 5 contributors this week?", "Who won last week?", "When will a winner be selected?", "Close.");
		...
		case 616:
			...
			top5.forEach(entry -> sb.append(StringUtils.capitalize(entry.getKey())).append(" contributed @blu@").append(Misc.insertCommas(Integer.toString(entry.getValue()))).append("-"));
		...
		case 617:
			...
			List<Entry<String, Integer>> winners = new ArrayList<>(Server.getServerData().getWellOfGoodWill().getWinners().entrySet());
			if (winners.size() == 0) {
			...
			for (Entry<String, Integer> entry : winners) {
				sb.append(spot++).append(".) ").append(StringUtils.capitalize(entry.getKey())).append(" (@blu@").append(Misc.insertCommas(Integer.toString(entry.getValue()))).append("@bla@)-");
			}
			sendStatement(sb.toString().split("-"));
			c.nextChat = 613;
			break;
		...
		case 618:
			...
			long minutes = TimeUnit.MINUTES.convert(difference - (days * (60000 * 60 * 24)) - (60000 * 60 * hours), TimeUnit.MILLISECONDS);
			sendStatement("The next winner will be chosen in " + days + " days, " + hours + " hours, " + minutes + " minutes.",
					"This will be on " + formattedDate.format(calendar.getTime()) + ".");
			c.nextChat = 613;
			break;
		...
		case 620:
			sendOptions("I want to repair an item.", "I want to claim back an item that has degraded.", "I don't see the item I want to claim on the list.", "Nothing.");
			c.dialogueAction = 122;
			break;

		case 621:
			sendNpcChat("You can repair a damaged item by using it on me.", "Each item has a repair cost. Most repairs range from", "250,000k to 500,000k");
			c.nextChat = 622;
			break;

		case 622:
			sendNpcChat("If an item degrades and disappears, you can claim it.", "It costs 2x as much to claim it then it does to repair.");
			c.nextChat = 620;
			break;
		...
		case 623:
			...
			if (DegradableItem.forId(degradeList[0].getItemId()).isPresent())
				item1=ItemAssistant.getItemName(degradeList[0].getItemId())+" @red@"+(DegradableItem.forId(degradeList[0].getItemId()).get().getCost()*2)+" PKP";

			if (degradeList.length > 1 && DegradableItem.forId(degradeList[1].getItemId()).isPresent()) {
				item2 = ItemAssistant.getItemName(degradeList[1].getItemId()) + " @red@" + (DegradableItem.forId(degradeList[1].getItemId()).get().getCost() * 2) + " PKP";
			}
			if (degradeList.length > 2&& DegradableItem.forId(degradeList[2].getItemId()).isPresent()) {
				item3 = ItemAssistant.getItemName(degradeList[2].getItemId()) + " @red@" + (DegradableItem.forId(degradeList[2].getItemId()).get().getCost() * 2) + " PKP";
			}
			if (degradeList.length > 3&& DegradableItem.forId(degradeList[3].getItemId()).isPresent()) {
				item4 = ItemAssistant.getItemName(degradeList[3].getItemId()) + " @red@" + (DegradableItem.forId(degradeList[3].getItemId()).get().getCost() * 2) + " PKP";
			}
		...
		case 624:
			sendNpcChat("The list only shows up to 4 claimable items at a time.", "You can free up space by claiming items.", "It is good practice to never have more than three",
		...
		case 628:
			sendNpcChat("Hello, my name is Sigmund.", "I am looking for items I can merchant to other players.", "If you have any please trade me.");
			c.nextChat = -1;
			break;
		...
		case 633:
			sendOption5("10 Waves - Fire Cape", "20 Waves - Fire Cape", "63 Waves - Fire Cape", "How does it work?", "What are my rankings?");
		...
		case 635:
			this.sendStatement("The more waves you defeat in total, the better your reward.", "You may logout at anytime within the minigame.",
					"You are unable to teleport from within the minigame.");
			c.nextChat = 0;
			break;

		case 636:
			this.sendStatement("You have completed...", "Level 1 (10 Waves) " + c.waveInfo[0] + " times", "Level 2 (20 Waves) " + c.waveInfo[1] + " times",
					"Level 3 (63 Waves) " + c.waveInfo[2] + " times");
			c.nextChat = 0;
			break;
		...
		case 638:
			sendOptions("Yes, take me there.", "No, I was hoping to get my items back.", "No, I was wondering who holds the current record.", "Nevermind");
		...
		case 640:
			sendNpcChat("So you want to claim your lost items.", "It will cost a total of 500,000GP for all the items.", "Do you want them back?");
			c.nextChat = 641;
			break;
		...
		case 644:
			...
			sendNpcChat("The current record is set by @red@" + pair.getFirst() + "@bla@.", "The time to beat is @red@" + Misc.toFormattedMS(pair.getSecond()) + "@bla@.");
			c.nextChat = 638;
			break;
		...
		case 650:
			if (c.getMode().isIronman() || c.getMode().isUltimateIronman()) {
				...
				sendNpcChat("Hello there " + c.playerName + ".", "You're not enrolled as an iron man or ultimate iron man.", "I cannot assist you in anyway.");
				c.nextChat = -1;
			}
			break;

		case 651:
			sendOptions("What restrictions do I have?", "I would like to revert my account", "I am missing armour, do you have any?", "", "Close");
		...
		case 652:
			...
			if (c.getRevertOption().equals(Action.NPC.name())) {
				if (c.getRevertModeDelay() > 0) {
					sendNpcChat("You recently requested that your mode be reverted.", "You can cancel this if you want.", "Do you want to cancel the request to revert?");
					c.nextChat = 654;
				} else {
					sendNpcChat("I can do this for you, but it will take a few days.", "72 hours from now your account will be reverted.",
							"You can cancel this request within 72 hours.", "Would you like to revert to regular mode?");
					c.nextChat = 653;
				}
			} else if (c.getRevertOption().equals(Action.PERMANENT.name())) {
				sendNpcChat("You are not permitted to revert. Upon account", "creation you chose to have this mode permanently.", "There is no option to revert at this time.");
				c.nextChat = -1;
			} else {
				c.nextChat = -1;
				return;
		...
		case 654:
			sendOptions("Yes, cancel the request to revert to regular mode.", "No, keep the request, I want to revert.");
		...
		case 655:
			...
			sendNpcChat("You have chosen to revert to regular mode.", "Your account will revert in 72 hours.", "You can cancel this request anytime within 72 hours.");
			c.nextChat = -1;
			break;
		...
		case 657:
			sendStatement("This scroll will reset your defence to level 1.", "This action cannot be undone. You cannot be wearing any items.",
					"The scroll is only good for one usage.", "Are you sure you want to reset your defence to level 1?");
			c.nextChat = 658;
			break;
		...
		case 659:
			sendNpcChat("Iron man accounts cannot trade, stake or pickup items", "that do not belong to them. They do not gain experience",
					"in pvp combat. They must deal 75% of the damage dealt", "to an npc to get the drop. They do not get drops from pvp.");
			c.nextChat = 660;
			break;

		case 660:
			sendNpcChat("Ultimate Iron Man accounts have all the restrictions of", "regular Iron man accounts with the exception of a few",
					"other limitations. They cannot use the banking feature", "and when they die they lose all items except 'untradables'.");
			c.nextChat = -1;
			break;
		...
		case 661:
			...
			for (int[] equipment : set.getEquipment()) {
				for (int item : equipment) {
					if (Server.itemHandler.itemExists(c.playerName, item)) {
						sendNpcChat("One of your equipment pieces is still on the ground.", "You better hurry and grab it, this costs me money.");
						c.nextChat = -1;
						return;
					}
					if (!c.getItems().playerHasItem(item) && !c.getItems().isWearingItem(item) && !c.getItems().bankContains(item)) {
						items.add(item);
					}
				}
			}
			...
			if (c.getItems().freeSlots() < items.size()) {
				sendNpcChat("To return the equipment you must have equal", "free slots to the amount of armour pieces missing.", "You do not have enough space.");
				c.nextChat = -1;
				return;
			}
			...
			if (items.size() < 3) {
				sendNpcChat("You have been given back a fraction of the", "entire set of armour. The rest of the armour is", "on your person.");
			} else {
		...
		case 664:
			if (c.getArenaPoints() <= 0) {
				...
				sendNpcChat("Hello, you're doing pretty good against those mages.", "You've accumulated " + c.getArenaPoints() + " arena points.",
		...
		case 666:
			sendNpcChat("You must enter the arena and kill as many", "opposing mage's as you can. Killing a mage", "will provide you with 1 arena point.",
					"You can only engage in magic vs magic combat.");
			c.nextChat = 665;
			break;
		...
		case 668:
			sendNpcChat("After many hours spent, you have learned how to", "successfully create a slayer helmet (imbued).");
			c.nextChat = -1;
			break;
		...
		case 673:
			sendNpcChat("Welcome to Icarus!", "To start, this is home, where a lot of stuff happens", "Let me show you around!");
			c.nextChat = 674;
			break;
			
		case 674:
			c.getPA().movePlayer(1506, 3637, 0);
			sendNpcChat("Here are the main shops.", "You can buy a lot of armour, weapons, ammunition,", "food and potions here.");
			c.nextChat = 675;
			break;
			
		case 675:
			c.getPA().movePlayer(1496, 3631, 0); 
			sendNpcChat("Here we have the Crystal Chest, as well as the", "start of the RFD minigame to obtain Barrows Gloves!", "Outside, a clue handler can exchange clues for", "a master clue.");
			c.nextChat = 676;
			break;
		
		case 676:
			c.getPA().movePlayer(1512, 3631, 0);
			sendNpcChat("Slayer masters are located here.", "If you would like to do Wilderness Slayer", "talk to Krystillia!");
			c.nextChat = 645;
			break;
			
			// TODO TUTORIAL NEEDS FINISHING
		
		case 677:
			c.getPA().movePlayer(3096, 3510, 0);
			sendNpcChat("The Well of Goodwill and the altars can be", "found here. Donate GP to the well to get", "double xp, double pest control points, and", "double drops!");
			c.nextChat = 678;
			break;
			
		case 678:
			c.getPA().movePlayer(3096, 3501, 0);
			sendNpcChat("Want to make a little starter money?", "Steal from our wonderful stalls and sell", "the goods to Sigmund!");
			c.nextChat = 679;
			break;
		
		case 679:
			c.getPA().movePlayer(3087, 3501, 0);
			sendNpcChat("Finally, to teleport, simply open up", "your spellbook and select a teleport spell.", "You can choose your destination from there!");
			c.nextChat = 645;
			break;
		...
		case 711:
			c.getDH().sendOption5("How do I teleport?", "Are there any rules I must follow?", "How do I find my slayer tasks?", "What do I do with my pkp and vote tickets?", "Nothing..");
			c.dialogueAction = 711;
			break;

		case 712:
			sendNpcChat("To teleport through the world simply clicking a teleport", "icon in your spellbook. Depending on the", "icon you click, that catergory of teleports", "will be shown in the interface.");
			c.nextChat = 710;
			break;

		case 713:
			sendNpcChat("Yes, you must follow rules of this world.", "Make sure you are aware of them! You can", "find and read them by typing ::rules");
			c.nextChat = 710;
			break;

		case 714:
			sendNpcChat("To simply get a clue of where your current slayer task", "is, speak to a slayer master and they", "will be kind enough to tell you!");
			c.nextChat = 710;
			break;

		case 715:
			sendNpcChat("If you have been lucky enough to get your hands on", "one of those precious tickets, you can exchange", "them into points by using the Exchange Handler right", "inside the bank of edgeville!");
			c.nextChat = 710;
			break;
		case 1577:
			...
			break;
		/*
		 * Teleports Reworked by Ryan
		 * Makes it easier to add new ones. Better organization
		 */
		case 400:
		...
		case 399:
			...
			break;		
		case 401:
			sendOption5("@cr22@West Dragons", "@cr22@East Dragons", "@cr22@Dwarf Cave", "@cr22@Lava Dragons", "@cr22@Mage Bank");
			c.teleAction = 1;
			break;
		...
		case 404:
			sendOption5("@cr22@King Black Dragon", "@cr22@Chaos Elemental", "God Wars Dungeon", "Zulrah", "@blu@Next Page");
			c.teleAction = 3;
			break;
		...
		case 406:
			sendOption5("@cr22@Vet'ion", "@cr22@Venenatis", "@cr22@Scorpia", "@cr22@Crazy archaeologist", "@cr22@Chaos Fanatic");
			c.teleAction = 3434;
			break;
		...
		case 409:
			c.getDH().sendOption5("Brimhaven Dungeon", "Taverly Dungeon", "Relleka Dungeon", "Stronghold Slayer Cave", "Asgarnian Ice Dungeon");
			c.teleAction = 2;
			break;
			
		case 7286:
			c.getDH().sendOption2("@red@Fight Skotizo?", "Yes, I understand I must buy my items for 500k on death.", "I need to prepare some more.");
		...
		case 900:
			sendNpcChat4("Hello! Would you like to enable Daily Tasks?", "These tasks can be assigned and completed", "once a day for some pretty neat rewards!", "Enable Daily Tasks?", 1909, "Daily Task Master");
			c.nextChat = 901;
			break;
		case 901:
		...
		case 902:
			sendNpcChat2("Please select your preference on the type", "of tasks you would like to receive!", 1909, "Daily Task Master");
			c.nextChat = 903;
			break;
		case 903:
		...
		case 904:
			sendNpcChat2("You have enabled daily tasks! Please", "press continue to select a task preference.", 1909, "Daily Task Master");
			c.nextChat = 902;
			break;
		case 905:
			sendNpcChat2("You have disabled daily tasks! Talk to", "me if you change your mind.", 1909, "Daily Task Master");
			c.nextChat = 0;
			break;
			
		case 906:
			sendNpcChat2("Great, your tasks will now be PvM related", "until you change your mind!", 1909, "Daily Task Master");
			c.nextChat = 0;
			DailyTasks.complete(c);
			DailyTasks.assignTask(c);
			break;
		case 907:
			sendNpcChat2("Great, your tasks will now be Skilling related", "until you change your mind!", 1909, "Daily Task Master");
			c.nextChat = 0;
			DailyTasks.complete(c);
			DailyTasks.assignTask(c);
			break;
