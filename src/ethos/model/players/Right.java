...
public enum Right implements Comparator<Right> {
	...
	// Ironman Ranks
	IRONMAN(13, "3A3A3A"),
	ULTIMATE_IRONMAN(14, "717070", IRONMAN),
	HARDCORE_IRONMAN(24, "501c17", IRONMAN),
	DEAD_HARDCORE_IRONMAN(25, "3A3A3A", IRONMAN),
	HCIM_DEAD(26, "3A3A3A", DEAD_HARDCORE_IRONMAN), // Temp role, instantly gets changed
	// Cosmetic Ranks
	...
	public static final Right[] PRIORITY = { PLAYER, OSRS, IRONMAN, ULTIMATE_IRONMAN, CONTRIBUTOR, SPONSOR, SUPPORTER, DONATOR, SUPER_DONATOR, EXTREME_DONATOR, LEGENDARY, RESPECTED_MEMBER, TESTER, YOUTUBER, HELPER,
