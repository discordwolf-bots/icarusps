			...
			if (c.usingMagic && Config.RUNES_REQUIRED && runesNecessary) {
				if (MagicData.MAGIC_SPELLS[spell][8] > 0) { // deleting runes
					if (!wearingStaff(c, MagicData.MAGIC_SPELLS[spell][8])) {
						if (!c.getRunePouch().deleteRunesOnCast(MagicData.MAGIC_SPELLS[spell][8], MagicData.MAGIC_SPELLS[spell][9])) {
							c.getItems().deleteItem(MagicData.MAGIC_SPELLS[spell][8], c.getItems().getItemSlot(MagicData.MAGIC_SPELLS[spell][8]), MagicData.MAGIC_SPELLS[spell][9]);
						}
					}
				}
				if (MagicData.MAGIC_SPELLS[spell][10] > 0) {
					if (!wearingStaff(c, MagicData.MAGIC_SPELLS[spell][10])) {
						if (!c.getRunePouch().deleteRunesOnCast(MagicData.MAGIC_SPELLS[spell][10], MagicData.MAGIC_SPELLS[spell][11])) {
							c.getItems().deleteItem(MagicData.MAGIC_SPELLS[spell][10], c.getItems().getItemSlot(MagicData.MAGIC_SPELLS[spell][10]), MagicData.MAGIC_SPELLS[spell][11]);
						}
					}
				}
				if (MagicData.MAGIC_SPELLS[spell][12] > 0) {
					if (!wearingStaff(c, MagicData.MAGIC_SPELLS[spell][12])) {
						if (!c.getRunePouch().deleteRunesOnCast(MagicData.MAGIC_SPELLS[spell][12], MagicData.MAGIC_SPELLS[spell][13])) {
							c.getItems().deleteItem(MagicData.MAGIC_SPELLS[spell][12], c.getItems().getItemSlot(MagicData.MAGIC_SPELLS[spell][12]), MagicData.MAGIC_SPELLS[spell][13]);
						}
					}
				}
				if (MagicData.MAGIC_SPELLS[spell][14] > 0) {
					if (!wearingStaff(c, MagicData.MAGIC_SPELLS[spell][14])) {
						if (!c.getRunePouch().deleteRunesOnCast(MagicData.MAGIC_SPELLS[spell][14], MagicData.MAGIC_SPELLS[spell][15])) {
							c.getItems().deleteItem(MagicData.MAGIC_SPELLS[spell][14], c.getItems().getItemSlot(MagicData.MAGIC_SPELLS[spell][14]), MagicData.MAGIC_SPELLS[spell][15]);
						}
					}
				}
			}
