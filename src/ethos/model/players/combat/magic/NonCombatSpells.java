		...
		case 1162: // low alch
			if (System.currentTimeMillis() - c.alchDelay > 1000) {
				if (c.getItems().playerHasItem(itemId, slot, 1)) {
					c.sendMessage("ItemId: <col=ff0000><shad=000000>" + itemId + "</shad></col>");
					...
					c.sendMessage("Reward: <col=ff0000><shad=000000>" + reward + "</shad></col>");
					int playerAmount = c.getItems().getItemAmount(995);
					c.sendMessage("PlayerAmount: <col=ff0000><shad=000000>" + playerAmount + "</shad></col>");
