...
public class RangeExtras {
	...
	public static boolean boltSpecialAvailable(Player player, int bolt) {
		...
		case 9244:
		case 9245:
			probability = player.getRechargeItems().hasItem(11785) || player.getRechargeItems().hasItem(9185) ? 18 : 20;
			break; 
			

		case 9242:
			probability = player.getRechargeItems().hasItem(11785) || player.getRechargeItems().hasItem(9185) ? 45 : 50;
			break;
		...
		//if (player.getName().equalsIgnoreCase("jeff")) probability = 2;
