...
public enum WeaponPerks {
	 ...
	 */
	LEVEL_10(10, 0, 0, 5, 0, 0, 0, 0),
	LEVEL_20(20, 0, 0, 5, 5, 0, 0, 0),
	LEVEL_30(30, 0, 0, 10, 5, 5, 0, 0),
	LEVEL_40(40, 0, 0, 10, 5, 10, 0, 0),
	LEVEL_50(50, 30, 3, 10, 5, 10, 0, 0),
	LEVEL_60(60, 30, 5, 15, 5, 10, 0, 0),
	LEVEL_70(70, 20, 5, 15, 7, 10, 0, 0),
	LEVEL_80(80, 20, 5, 20, 7, 10, 0, 0),
	LEVEL_90(90, 10, 6, 20, 7, 10, 0, 0),
	LEVEL_99(99, 10, 6, 25, 10, 10, 1, 0);
	...
	// Constructor
	private WeaponPerks(int levelRequired, int poisonChance, int poisonDamage, int critical, int minDamage, int maxDamage, int weaponSpeed, int lifeSteal) {
