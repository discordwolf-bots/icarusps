...
public class MonsterHunt {
	...
	public enum Npcs {
		...
		GLOD(5129, "Wildy Glod", 1500, 75, 350, 400),
		ICE_QUEEN(4922, "Barrage Bitch", 1500, 55, 350, 400);
...
//				PlayerHandler.executeGlobalMessage("@cr10@ @red@[Wildy Pursuit] @bla@" + randomNpc.getMonsterName() + " has been spotted near " + randomLocation.getLocationName() + ".");
//				PlayerHandler.executeGlobalMessage("@cr10@ @red@[Wildy Pursuit] @bla@Teleport to it now by typing ::telepursuit");
//				spawned = true;
			}
