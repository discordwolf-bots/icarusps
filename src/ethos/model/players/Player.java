...
public Inferno inferno = new Inferno(this, Boundary.INFERNO, 0);
	 ...
	 * Integers
	 */
	public int raidPoints, unfPotHerb, unfPotAmount, wrenchObject = 0, halloweenOrderNumber = 0, speed1 = -1, speed2 = -1, safeBoxSlots = 15, hostAmount = 3, corpDamage = 0,
			direction = -1, dialogueOptions = 0, sireHits = 0, lastMenuChosen = 0, dreamTime, unNoteItemId = 0, lootValue = 0, lowMemoryVersion = 0, emote, gfx, timeOutCounter = 0, returnCode = 2, currentRegion = 0, diceItem, page, specRestore = 0, gwdAltar = 0, lastClickedItem, slayerTasksCompleted,
			pestControlDamage, playerRank = 0, packetSize = 0, packetType = -1, makeTimes, event, ratsCaught, summonId, bossKills, droppedItem = -1, kbdCount, dagannothCount,
			krakenCount, chaosCount, armaCount, bandosCount, saraCount, zammyCount, barrelCount, moleCount, callistoCount, venenatisCount, vetionCount, rememberNpcIndex, diceMin,
			diceMax, otherDiceId, betAmount, totalProfit, betsWon, betsLost, slayerPoints = 0, playTime, killStreak, day, month, YEAR, totalLevel, xpTotal, smeltAmount = 0,
			smeltEventId = 5567, waveType, achievementsCompleted, achievementPoints, fireslit, crabsKilled, treesCut, pkp, killcount, deathcount, votePoints, bloodPoints, amDonated, level1 = 0,
			level2 = 0, level3 = 0, treeX, treeY, homeTele = 0, homeTeleDelay = 0, lastLoginDate, playerBankPin, recoveryDelay = 3, attemptsRemaining = 3, lastPinSettings = -1,
			setPinDate = -1, changePinDate = -1, deletePinDate = -1, firstPin, secondPin, thirdPin, fourthPin, bankPin1, bankPin2, bankPin3, bankPin4, pinDeleteDateRequested,
			saveDelay, playerKilled, totalPlayerDamageDealt, killedBy, lastChatId = 1, friendSlot = 0, dialogueId, specEffect, specBarId, attackLevelReq, defenceLevelReq,
			strengthLevelReq, rangeLevelReq, magicLevelReq, followId, skullTimer, votingPoints, nextChat = 0, talkingNpc = -1, dialogueAction = 0, autocastId, followDistance,
			followId2, barrageCount = 0, delayedDamage = 0, delayedDamage2 = 0, pcPoints = 0, donatorPoints = 0, magePoints = 0, lastArrowUsed = -1, clanId = -1, autoRet = 0,
			pcDamage = 0, xInterfaceId = 0, xRemoveId = 0, xRemoveSlot = 0, tzhaarToKill = 0, tzhaarKilled = 0, waveId, rfdWave = 0, rfdChat = 0, rfdGloves = 0, frozenBy = 0,
			teleAction = 0, newPlayerAct = 0, bonusAttack = 0, lastNpcAttacked = 0, killCount = 0, actionTimer, rfdRound = 0, roundNpc = 0, desertTreasure = 0, horrorFromDeep = 0,
			QuestPoints = 0, doricQuest = 0, teleGrabItem, teleGrabX, teleGrabY, duelCount, underAttackBy, underAttackBy2, wildLevel, teleTimer, respawnTimer, saveTimer = 0,
			teleBlockLength, focusPointX = -1, focusPointY = -1, WillKeepAmt1,
			WillKeepAmt2, WillKeepAmt3, WillKeepAmt4, WillKeepItem1, WillKeepItem2, WillKeepItem3, WillKeepItem4, WillKeepItem1Slot, WillKeepItem2Slot, WillKeepItem3Slot,
			WillKeepItem4Slot, EquipStatus, faceNPC = -1, DirectionCount = 0, itemUsing, attempts = 3, follow2 = 0, antiqueSelect = 0, leatherType = -1, DELAY = 1250, rangeEndGFX,
			boltDamage, teleotherType, playerTradeWealth, doAmount, woodcuttingTree, stageT, dfsCount, recoilHits, playerDialogue, clawDelay, previousDamage, prayerId = -1,
			headIcon = -1, bountyIcon = 0, headIconPk = -1, headIconHints, specMaxHitIncrease, freezeDelay, freezeTimer = -6, teleportTimer = 0, killerId, playerIndex,
			oldPlayerIndex, lastWeaponUsed, projectileStage, crystalBowArrowCount, playerMagicBook, teleGfx, teleEndAnimation, teleHeight, teleX, teleY, rangeItemUsed,
			killingNpcIndex, totalDamageDealt, oldNpcIndex, fightMode, attackTimer, npcIndex, npcClickIndex, npcType, castingSpellId, oldSpellId, spellId, hitDelay, bowSpecShot,
			clickNpcType, clickObjectType, objectId, objectX, objectY, objectXOffset, objectYOffset, objectDistance, itemX, itemY, itemId, myShopId, tradeStatus, tradeWith,
			amountGifted, playerAppearance[] = new int[13], apset, actionID, wearItemTimer, wearId, wearSlot, interfaceId, XremoveSlot, XinterfaceID, XremoveID, Xamount,
			fishTimer = 0, smeltType, smeltTimer = 0, attackAnim, animationRequest = -1, animationWaitCycles, combatLevel, wcTimer = 0, miningTimer = 0, castleWarsTeam, npcId2 = 0,
			playerStandIndex = 0x328, playerTurnIndex = 0x337, playerWalkIndex = 0x333, playerTurn180Index = 0x334, playerTurn90CWIndex = 0x335, playerTurn90CCWIndex = 0x336,
			playerRunIndex = 0x338, playerHat = 0, playerCape = 1, playerAmulet = 2, playerWeapon = 3, playerChest = 4, playerShield = 5, playerLegs = 7, playerHands = 9,
			playerFeet = 10, playerRing = 12, playerArrows = 13, playerAttack = 0, playerDefence = 1, playerStrength = 2, playerHitpoints = 3, playerRanged = 4, playerPrayer = 5,
			playerMagic = 6, playerCooking = 7, playerWoodcutting = 8, playerFletching = 9, playerFishing = 10, playerFiremaking = 11, playerMining = 14, playerHerblore = 15,
			playerAgility = 16, playerThieving = 17, playerSlayer = 18, playerFarming = 19, playerRunecrafting = 20, fletchingType, getHeightLevel, mapRegionX, mapRegionY, absX,
			absY, currentX, currentY, heightLevel, playerSE = 0x328, playerSEW = 0x333, playerSER = 0x334, npcListSize = 0, dir1 = -1, dir2 = -1, poimiX = 0, poimiY = 0,
			playerListSize = 0, wQueueReadPtr = 0, wQueueWritePtr = 0, teleportToX = -1, teleportToY = -1, pitsStatus = 0, safeTimer = 0, mask100var1 = 0, mask100var2 = 0,
			face = -1, FocusPointX = -1, FocusPointY = -1, newWalkCmdSteps = 0, tablet = 0, wellItem = -1, wellItemPrice = -1;
	private int chatTextColor = 0, chatTextEffects = 0, dragonfireShieldCharge, runEnergy = 100, lastEnergyRecovery, x1 = -1, y1 = -1, x2 = -1, y2 = -1, privateChat, shayPoints, arenaPoints, toxicStaffOfTheDeadCharge, toxicBlowpipeCharge, toxicBlowpipeAmmo, toxicBlowpipeAmmoAmount, serpentineHelmCharge,
	...
	public int[] halloweenRiddleGiven = new int[10], halloweenRiddleChosen = new int[10], masterClueRequirement = new int[4], waveInfo = new int[3], keepItems = new int[4],
			...
			woodcut = new int[7], farm = new int[2], playerEquipment = new int[14], playerEquipmentN = new int[14],
			playerLevel = new int[25], playerXP = new int[25], damageTaken = new int[Config.MAX_PLAYERS],
			purchasedTeleport = new int[3], runeEssencePouch = new int[3], pureEssencePouch = new int[3];
	...
	public String wrenchUsername = "", wogwOption = "", forcedText = "null", connectedFrom = "", quizAnswer = "", globalMessage = "", playerName = null, playerName2 = null, playerPass = null, date, clanName, properName, bankPin = "",
			lastReported = "", currentTime, barType = "", playerTitle = "", rottenPotatoOption = "";
	 ...
	 * Booleans
	 */
	public boolean[] invSlot = new boolean[28], equipSlot = new boolean[14], playerSkilling = new boolean[20], clanWarRule = new boolean[10], duelRule = new boolean[22];
	public boolean teleportingToDistrict = false, morphed = false, isIdle = false, boneOnAltar = false, dropRateInKills = true, droppingItem = false, acceptAid = false, settingUnnoteAmount = false, settingLootValue = false, didYouKnow = true, yellChannel = true, documentGraphic = false, documentAnimation = false, inProcess = false, isStuck = false, isBusyFollow = false, hasOverloadBoost, needsNewTask = false, keepTitle = false, killTitle = false, hide = false, settingMin, settingMax,
			settingBet, playerIsCrafting, viewingLootBag = false, addingItemsToLootBag = false, viewingRunePouch = false, hasFollower = false, updateItems = false, claimedReward, craftDialogue, battlestaffDialogue, braceletDialogue, isAnimatedArmourSpawned, isSmelting = false, hasEvent, expLock = false,
			buyingX, leverClicked = false, isBanking = true, inSafeBox = false, isCooking = false, initialized = false, disconnected = false, ruleAgreeButton = false, rebuildNPCList = false,
			isActive = false, isKicked = false, isSkulled = false, friendUpdate = false, newPlayer = false, hasMultiSign = false, saveCharacter = false, mouseButton = false,
			splitChat = false, chatEffects = true, nextDialogue = false, autocasting = false, usedSpecial = false, mageFollow = false, dbowSpec = false,
			craftingLeather = false, properLogout = false, secDbow = false, maxNextHit = false, ssSpec = false, vengOn = false, addStarter = false, startPack = false,
			accountFlagged = false, msbSpec = false, dtOption = false, dtOption2 = false, doricOption = false, doricOption2 = false, caOption2 = false, caOption2a = false,
			caOption4a = false, caOption4b = false, caOption4c = false, caPlayerTalk1 = false, horrorOption = false, rfdOption = false, inDt = false, inHfd = false,
			disableAttEvt = false, AttackEventRunning = false, npcindex, spawned = false, hasBankPin, enterdBankpin, firstPinEnter, requestPinDelete, secondPinEnter, thirdPinEnter,
			fourthPinEnter, hasBankpin, appearanceUpdateRequired = true, isDead = false, randomEvent = false, FirstClickRunning = false, WildernessWarning = false, storing = false,
			canChangeAppearance = false, mageAllowed, isFullBody = false, isFullHelm = false, isFullMask = false, isOperate, usingLamp = false, normalLamp = false,
			antiqueLamp = false, setPin = false, teleporting, isWc, wcing, usingROD = false, multiAttacking, rangeEndGFXHeight, playerFletch, playerIsFletching, playerIsMining,
			playerIsFiremaking, playerIsFishing, playerIsCooking, below459 = true, defaultWealthTransfer, updateInventory, oldSpec, stopPlayerSkill, playerStun, stopPlayerPacket,
			usingClaws, playerBFishing, finishedBarbarianTraining, ignoreDefence, secondFormAutocast, usingArrows, usingOtherRangeWeapons, usingCross, usingBallista, magicDef, spellSwap,
			recoverysSet, protectItem = false, doubleHit, usingSpecial, npcDroppingItems, usingRangeWeapon, usingBow, usingMagic, usingAirSpells, usingWaterSpells, usingFireSpells,
			usingMelee, magicFailed, oldMagicFailed, isMoving, walkingToItem, isShopping, updateShop, forcedChatUpdateRequired, inDuel, tradeAccepted, goodTrade, inTrade,
			tradeRequested, tradeResetNeeded, tradeConfirmed, tradeConfirmed2, canOffer, acceptTrade, acceptedTrade, smeltInterface, patchCleared, saveFile = false,
			usingGlory = false, usingSkills = false, fishing = false, isRunning2 = true, takeAsNote, inCwGame, inCwWait, isNpc, seedPlanted = false, seedWatered = false, patchCleaned = false,
			patchRaked = false, inPits = false, bankNotes = false, isRunning = true, inSpecMode = false, didTeleport = false, mapRegionDidChange = false, createItems = false,
			slayerHelmetEffect, inArdiCC, attackSkill = false, strengthSkill = false, defenceSkill = false, mageSkill = false, rangeSkill = false, prayerSkill = false,
			healthSkill = false, usingChin, infoOn = false, pkDistrict = false, crystalDrop = false, hourlyBoxToggle = true, fracturedCrystalToggle = true, boltTips = false, arrowTips = false, javelinHeads = false;
	private boolean incentiveWarning, dropWarning = true, chatTextUpdateRequired = false, newWalkCmdIsRunning = false, dragonfireShieldActive,
			forceMovement, invisible, godmode, safemode, trading, stopPlayer, isBusy = false, isBusyHP = false, forceMovementActive = false;
	 ...
	 * Longs
	 */
	public long wogwDonationAmount, lastAuthClaim, totalGorillaDamage, totalGorillaHitsDone, totalMissedGorillaHits, lastImpling, lastWheatPass, lastRoll, lastCloseOfInterface, lastPerformedEmote, lastPickup, lastTeleport, lastMarkDropped, lastObstacleFail, lastForceMovement, lastDropTableSelected, lastDropTableSearch, lastDamageCalculation, lastBankDeposit, lastBankDeposit2, buySlayerTimer, buyPestControlTimer, fightCaveLeaveTimer, infernoLeaveTimer, lastFire, lastMove, bonusXpTime, yellDelay, craftingDelay, lastSmelt = 0,
			lastMysteryBox, lastYell, diceDelay, lastChat, lastRandom, lastCaught = 0, lastAttacked, lastTargeted, homeTeleTime, lastDagChange = -1, reportDelay, lastPlant,
			objectTimer, npcTimer, lastEss, lastClanMessage, lastCast, miscTimer, lastFlower, waitTime, saveButton = 0, lastButton, jailEnd, muteEnd, marketMuteEnd, lastReport = 0,
			stopPrayerDelay, prayerDelay, lastAntifirePotion, antifireDelay, staminaDelay, lastRunRecovery, rangeDelay, stuckTime, friends[] = new long[200], lastUpdate = System.currentTimeMillis(),
			lastPlayerMove = System.currentTimeMillis(), lastHeart = 0, lastSpear = System.currentTimeMillis(), lastProtItem = System.currentTimeMillis(), dfsDelay = System.currentTimeMillis(),
			lastVeng = System.currentTimeMillis(), foodDelay = System.currentTimeMillis(), switchDelay = System.currentTimeMillis(), potDelay = System.currentTimeMillis(),
			teleGrabDelay = System.currentTimeMillis(), protMageDelay = System.currentTimeMillis(), protMeleeDelay = System.currentTimeMillis(),
			protRangeDelay = System.currentTimeMillis(), lastAction = System.currentTimeMillis(), lastThieve = System.currentTimeMillis(),
			lastLockPick = System.currentTimeMillis(), alchDelay = System.currentTimeMillis(), specCom = System.currentTimeMillis(), specDelay = System.currentTimeMillis(),
			duelDelay = System.currentTimeMillis(), teleBlockDelay = System.currentTimeMillis(), godSpellDelay = System.currentTimeMillis(),
			singleCombatDelay = System.currentTimeMillis(), singleCombatDelay2 = System.currentTimeMillis(), reduceStat = System.currentTimeMillis(),
			restoreStatsDelay = System.currentTimeMillis(), logoutDelay = System.currentTimeMillis(), buryDelay = System.currentTimeMillis(), cerbDelay = System.currentTimeMillis(),
			cleanDelay = System.currentTimeMillis(), wogwDelay = System.currentTimeMillis();
	private long revertModeDelay, experienceCounter, bestZulrahTime, lastIncentive, lastOverloadBoost, nameAsLong, lastDragonfireShieldAttack;
	...
	public byte playerInListBitmap[] = new byte[(Config.MAX_PLAYERS + 7) >> 3], npcInListBitmap[] = new byte[(NPCHandler.maxNPCs + 7) >> 3],
	...
	public void highscores() {
		getPA().sendFrame126("Icarus - Top PKers Online", 6399); // Title
		for (int i = 0; i < 10; i++) {
			if (ranks[i] > 0) {
	...
	public void destruct() {
		...
		if (raid.getRaidInstance() != null) {
			InstancedAreaManager.getSingleton().disposeOf(raid.getRaidInstance());
		}
		if (tzkalzuk != null) {
	...
	public void loadDiaryTab() {
		this.getPA().sendFrame126("@gre@Provinces completed: "+amountOfDiariesComplete()+"/11", 29295);
		this.getPA().sendFrame126(getDiaryManager().getVarrockDiary().hasDoneAll() ? "@gre@Varrock" : "@or1@Varrock", 29305);
		this.getPA().sendFrame126(getDiaryManager().getArdougneDiary().hasDoneAll() ? "@gre@Ardougne" : "@or1@Ardougne", 29306);
		this.getPA().sendFrame126(getDiaryManager().getDesertDiary().hasDoneAll() ? "@gre@Desert" : "@or1@Desert", 29307);
		this.getPA().sendFrame126(getDiaryManager().getFaladorDiary().hasDoneAll() ? "@gre@Falador" : "@or1@Falador", 29308);
		this.getPA().sendFrame126(getDiaryManager().getFremennikDiary().hasDoneAll() ? "@gre@Fremennik" : "@or1@Fremennik", 29309);
		this.getPA().sendFrame126(getDiaryManager().getKandarinDiary().hasDoneAll() ? "@gre@Kandarin" : "@or1@Kandarin", 29310);
		this.getPA().sendFrame126(getDiaryManager().getKaramjaDiary().hasDoneAll() ? "@gre@Karamja" : "@or1@Karamja", 29311);
		this.getPA().sendFrame126(getDiaryManager().getLumbridgeDraynorDiary().hasDoneAll() ? "@gre@Lumbridge & Draynor" : "@or1@Lumbridge & Draynor", 29312);
		this.getPA().sendFrame126(getDiaryManager().getMorytaniaDiary().hasDoneAll() ? "@gre@Morytania" : "@or1@Morytania", 29313);
		this.getPA().sendFrame126(getDiaryManager().getWesternDiary().hasDoneAll() ? "@gre@Western" : "@or1@Western", 29314);
		this.getPA().sendFrame126(getDiaryManager().getWildernessDiary().hasDoneAll() ? "@gre@Wilderness" : "@or1@Wilderness", 29315);
	}
	...
	public void initialize() {
		try {
			 ...
			 * Welcome messages
			 */
			int primary = rights.getPrimary().getValue();
			String nameIdentifier = primary > 0 ? "<img=" + (primary-1) + ">" : "";
			// <img=16>
			sendMessage("Welcome to <col=ff0000><shad=000000>IcarusPS</shad></col>, " + nameIdentifier + getName());
			if (Config.ALPHA)
				sendMessage("This game is currently in <shad=000000>BETA</shad>");
			if (Config.DOUBLE_DROPS && Config.DOUBLE_VOTE_INCENTIVES)
				sendMessage("<img=16>Vote and receive 2x drops and 2x vote rewards.");
			if (DoubleExperience.isDoubleExperience(this))
				sendMessage("<img=16>Bonus Weekend is @red@LIVE@bla@! Bonus voting, PKP and XP!");
			if (Config.CYBER_MONDAY)
				sendMessage("@cr8@Christmas sale is @red@LIVE@bla@! 20% off on all purchases! @red@::store");
		...
		//	checkWellOfGoodwillTimers();
			...
			setSidebarInterface(1, 3917); //Skilltab > 3917
			...
			setSidebarInterface(11, 23000); // wrench tab
	...
	/**
	 * Update {@link #equippedGodItems}, which is a list of all gods of which the player has at least 1 item equipped.
	 */
	...
	public int[] SLAYER_HELMETS = {
			11864, 11865, 
			19639, 19641,
			19643, 19645,
			19647, 19649
	};
	public int[] IMBUED_SLAYER_HELMETS = {
		11865, 19641, 19645, 19649	
	};
	...
	public long acidPoolTimer;
	public long iceStormTimer;
	public boolean olmShake;
	
	public void process() {
		
		if (RaidMonsters.GREAT_OLM.isInBounds(this)) {
			if (!olmShake) {
				getPA().shakeScreen(3, 2, 3, 2);
				olmShake = true;
			}
			if (this.getRaids().isInAcid()) {
				this.appendDamage(1, Hitmark.POISON);
				if (this.getHealth().getStatus() != HealthStatus.POISON) {
					this.getHealth().proposeStatus(HealthStatus.POISON, 5,  Optional.of(this));
				}
			}
		} else {
			if (olmShake) {
		...
		//Test by setting your play-time char file variable to 10775, upon logging in you will be rewarded 25 seconds after.
		if (this.playTime % 3600 == 0 && !isIdle && !trading){
			if (getHourlyBoxToggle() == true) {
				//getItems().addItemUnderAnyCircumstance(11739, 1);
				//sendMessage("[ @red@Reward @bla@] <img=1>@blu@Thank you for continuing to play Icarus, here is an @red@Hourly Reward Box@bla@!");
			} else {
		...
		if (inWild() && Boundary.isIn(this, Boundary.SAFEPK)) {
			...
			if (Config.SINGLE_AND_MULTI_ZONES) {
				getPA().sendFrame126("@gre@Safe PK", 199);
			} else {
				getPA().multiWay(-1);
				getPA().sendFrame126("@gre@Safe PK", 199);
			}
...
//			getPA().walkableInterface(42300);
		...
		if (underAttackBy <= 0 && underAttackBy2 <= 0 && !inMulti() && lastAttacked < System.currentTimeMillis() - 4000 && lastTargeted < System.currentTimeMillis() - 4000) {
			NPC closestNPC = null;
			...
			if(!isIdle) {
				for (NPC npc : NPCHandler.npcs) {
					...
					if (distance < closestDistance && distance <= Server.npcHandler.distanceRequired(npc.getIndex()) + Server.npcHandler.followDistance(npc.getIndex())) {
	...
	public void correctCoordinates() {
		...
		if (x > zulrah.getMinimumX() && x < zulrah.getMaximumX() && y > zulrah.getMinimumY() && y < zulrah.getMaximumY()) {
	...
	public final int[] NO_ARROW_DROP = { 11959, 10033, 10034, 4212, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 4734, 4934, 4935, 4936, 4937 };
	public final int[] OTHER_RANGE_WEAPONS = { 11959, 10033, 10034, 800, 801, 802, 803, 804, 805, 20849, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 825, 826, 827, 828, 829, 830,
			831, 832, 833, 834, 835, 836, 863, 864, 865, 866, 867, 868, 869, 870, 871, 872, 873, 874, 875, 876, 4934, 4935, 4936, 4937, 5628, 5629, 5630, 5632, 5633, 5634, 5635,
			5636, 5637, 5639, 5640, 5641, 5642, 5643, 5644, 5645, 5646, 5647, 5648, 5649, 5650, 5651, 5652, 5653, 5654, 5655, 5656, 5657, 5658, 5659, 5660, 5661, 5662, 5663, 5664,
			5665, 5666, 5667, 6522, 11230 };
	...
	public final String[] PRAYER_NAME = { "Thick Skin", "Burst of Strength", "Clarity of Thought", "Sharp Eye", "Mystic Will", "Rock Skin", "Superhuman Strength",
			"Improved Reflexes", "Rapid Restore", "Rapid Heal", "Protect Item", "Hawk Eye", "Mystic Lore", "Steel Skin", "Ultimate Strength", "Incredible Reflexes",
			"Protect from Magic", "Protect from Missiles", "Protect from Melee", "Eagle Eye", "Mystic Might", "Retribution", "Redemption", "Smite", "Chivalry", "Piety" };
	...
	public boolean[] prayerActive = { false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false,
			false, false, false, false, false, false };

	//Used by farming processor to not update the object every click
	//Created an array of booleans based on the patch number, not using an array for each patch creates graphic glitches. - Tyler
	...
	/**
	 * Retrieves the bounty hunter instance for this client object. We use lazy initialization because we store values from the player save file in the bountyHunter object upon
	 * login. Without lazy initialization the value would be overwritten.
	 * 
	...
	public void BestItem4(Player c) {
		...
		for (int ITEM = 0; ITEM < 28; ITEM++) {
			if (playerItems[ITEM] > 0) {
				NextValue = (int) Math.floor(ShopAssistant.getItemShopValue(playerItems[ITEM] - 1));
				if (NextValue > BestValue && !(ITEM == WillKeepItem1Slot && playerItems[ITEM] - 1 == WillKeepItem1)
						&& !(ITEM == WillKeepItem2Slot && playerItems[ITEM] - 1 == WillKeepItem2) && !(ITEM == WillKeepItem3Slot && playerItems[ITEM] - 1 == WillKeepItem3)) {
					BestValue = NextValue;
	 ...
	 * 
	 * @param itemId the item to be kept
...
//		return playerEquipment[playerHat] == 11664 && playerEquipment[playerLegs] == 8840 || playerEquipment[playerLegs] == 13073 && playerEquipment[playerChest] == 8839
//				|| playerEquipment[playerChest] == 13072 && playerEquipment[playerHands] == 8842;

		if (getItems().isWearingItem(11664) && 
			getItems().isWearingItem(8840) && 
			getItems().isWearingItem(8839) && 
			getItems().isWearingItem(8842)) {
			return true;
		}
		if (getItems().isWearingItem(11664) && 
			getItems().isWearingItem(13073) && 
			getItems().isWearingItem(13072) && 
			getItems().isWearingItem(8842)) {
			return true;
		}
		return false;
...
//		return playerEquipment[playerHat] == 11663 && playerEquipment[playerLegs] == 8840 || playerEquipment[playerLegs] == 13073 && playerEquipment[playerChest] == 8839
//				|| playerEquipment[playerChest] == 13072 && playerEquipment[playerHands] == 8842;

		if (getItems().isWearingItem(11663) && 
			getItems().isWearingItem(8840) && 
			getItems().isWearingItem(8839) && 
			getItems().isWearingItem(8842)) {
			return true;
	...
	public boolean fullVoidMelee() {
		if (getItems().isWearingItem(11665) && 
			getItems().isWearingItem(8840) && 
			getItems().isWearingItem(8839) && 
			getItems().isWearingItem(8842)) {
			return true;
	...
	public boolean inBank() {
		return Area(3090, 3099, 3487, 3500) || Area(3089, 3090, 3492, 3498) || Area(3248, 3258, 3413, 3428) || Area(3179, 3191, 3432, 3448) || Area(2944, 2948, 3365, 3374)
				|| Area(2942, 2948, 3367, 3374) || Area(2944, 2950, 3365, 3370) || Area(3008, 3019, 3352, 3359) || Area(3017, 3022, 3352, 3357) || Area(3203, 3213, 3200, 3237)
				|| Area(3212, 3215, 3200, 3235) || Area(3215, 3220, 3202, 3235) || Area(3220, 3227, 3202, 3229) || Area(3227, 3230, 3208, 3226) || Area(3226, 3228, 3230, 3211)
	...
	public boolean inMulti() {
		...
		if (Boundary.isWithRaids(this)) { // raids main rooms
			return true;
		}
	...
	public int distanceToPoint(int pointX, int pointY, int pointZ) {
		return (int) Math.sqrt(Math.pow(absX - pointX, 2) + Math.pow(absY - pointY, 2) + Math.pow(Math.abs(heightLevel) - pointZ, 2));
	}
	...
	/**
	 * Checks the combat distance to see if the player is in an appropriate location based on the attack style.
	 * 
	 * @param attacker
	 * @param target
	 * @return
	...
	public boolean checkCombatDistance(Player attacker, Player target) {
		...
		return (this.usingMagic || this.usingRangeWeapon || this.usingBow || this.autocasting || this.usingBallista) && distance <= required_distance ? true
				: (this.usingMelee && this.isMoving && distance <= required_distance ? true
						: distance == 1 && (this.freezeTimer <= 0 || this.getX() == target.getX() || this.getY() == target.getY()));
	}

	public int getDistanceRequired() {
		return !this.usingMagic && !this.usingBallista && !this.usingRangeWeapon && !usingBow && !this.autocasting ? (this.isMoving ? 3 : 1) : 9;
	}
	...
	public int getNextWalkingDirection() {
		...
		/*
		 * if (isRunning()) { Client c = (Client) this; if (runEnergy > 0) { runEnergy--; c.getPA().sendFrame126(runEnergy + "%", 149); } else { isRunning2 = false;
...
//			return;
	...
	public void setForceMovement(int xOffset, int yOffset, int speedOne, int speedTwo, String directionSet, int animation) {
			...
			Server.getEventHandler().submit(new Event<Player>("force_movement", this, 2) {
				...
				public void execute() {
					...
					attachment.direction = directionSet == "NORTH" ? 0 : directionSet == "EAST" ? 1 : directionSet == "SOUTH" ? 2 : directionSet == "WEST" ? 3 : 0;
					super.stop();
				}
			});
			Server.getEventHandler().submit(new Event<Player>("force_movement", this, Math.abs(xOffsetWalk) + Math.abs(yOffsetWalk) + 3) {
			...
			if (!found)
				...
				if (dir != -1 && (dir & 1) != 0) {
					...
					if (dir == -1 || (dir & 1) != 0) {
						...
						if (!found) {
							println_debug("Fatal: Internal error: unable to determine connection vertex!" + "  wp1=(" + wayPointX1 + ", " + wayPointY1 + "), wp2=(" + wayPointX2
	...
	public boolean susceptibleTo(HealthStatus status) {
		if (getItems().isWearingItem(12931, playerHat) || getItems().isWearingItem(13199, playerHat) || getItems().isWearingItem(13197, playerHat)) {
			return false;
		}
		return true;
	}
