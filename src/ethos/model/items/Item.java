...
public class Item {
	 ...
	 * Server cape IDs.
	 */
	public static int capes[] = { 2731, 2677, 2683, 2680, 2701, 2686, 2689, 2692, 2737, 2734, 2716, 2728, 2695, 2713,
	...
	public static int legs[] = { 10438, 10434, 20842, 10430, 10426, 10422, 10418, 10414, 10410, 10406, 10402, 7609, 2522, 7378,
			...
			7398, 7386, 6324, 6343, 6353, 7116, 7126, 7132, 7134, 3387, 5036, 5038, 5040, 13873 };
	...
	private static String[] fullbody = { "platebody", "plate", "top", "wings", "blouse", "monk's robe", "shirt",
			...
			"robe (g)", "robe (t)", "zamorak robe", "hauberk", "coat", "Mummy", "varrock", "decorative", "garb", "zamorak robe"
	...
	private static String[] fullmask = { "helm", "helmet_imbued", "helm_(g)", "Bronze_full_helm", "Iron_full_helm",
			...
			"slayer helmet (i)", "rogue mask", "santa mask", "antisanta mask", "Splitbark helm",
	};
