...
public class ItemAssistant {
	...
	public void deleteEquipment() {
		if (!c.getItems().isWearingItem(10033) && !c.getItems().isWearingItem(10034)
			...
			if (c.getItems().isWearingItem(10499, c.playerCape) || SkillcapePerks.RANGING.isWearing(c)
	...
	public void dropArrowNpc(NPC npc) {
		if (c.playerEquipment[c.playerCape] == 10499 || SkillcapePerks.RANGING.isWearing(c) || SkillcapePerks.isWearingMaxCape(c)) {
			return;
		}
		int enemyX = npc.getX();
		int enemyY = npc.getY();
