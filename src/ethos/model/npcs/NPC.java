...
public void followNPC() {
	 ...
	 * @param y
	 * @return
	 * 		the exact distance between ponits.
	 */
	...
	/**
	 * Sends the request to a client that the npc should be transformed into another.
	 * 
	...
	/**
	 * An object containing specific information about the NPC such as the combat level, default maximum health, the name, etcetera.
	 * 
