...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(int i) {
		...
		case 7145:
		case 7146:
			return npcs[i].attackType == CombatType.MAGE ? 7225 : npcs[i].attackType == CombatType.RANGE ? 7227 : npcs[i].attackType == CombatType.SPECIAL ? 7225 : 7239;
		
		case 5890: //Abyssal sire
			return npcs[i].attackType == CombatType.MELEE ? Misc.random(1) == 0 ? 5366 : 5369 : npcs[i].attackType == CombatType.MAGE ? 5751 : npcs[i].attackType == CombatType.SPECIAL ? 5367 : -1;
		...
		case 319: // Corporeal Beast
			return npcs[i].attackType == CombatType.MAGE ? 1680 : npcs[i].attackType == CombatType.SPECIAL ? 1680 : 1682;
		case 320:
			return 1689;
