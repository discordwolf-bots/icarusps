...
public class PrestigeSkills {
	...
	public int points = 1000; // This is the base prestige points given
	...
	public void registerClick(int i) {
		...
		player.getPA().sendFrame126("Reward: @whi@"+(points + (100 * (player.currentPrestigeLevel + 1)))+" Points", 37309); // Update Reward
