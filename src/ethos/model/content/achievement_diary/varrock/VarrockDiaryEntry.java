...
public enum VarrockDiaryEntry {
	//Easy
	VARROCK_ROOFTOP("Run the varrock rooftop course: %totalstage" , 10),
	...
	//Elite
	SUPER_COMBAT("Create some super combat potions: %totalstage", 50),
	SMITH_RUNE_KNIFES("Smith some rune knifes: %totalstage", 100),
