    ...
    public enum Achievement {
      ...
      Bby_Dragon_Hunter_I(2, AchievementTier.TIER_1, AchievementType.SLAY_BABY_DRAGONS, null, "Kill 50 Baby Dragons", 50, 1, new GameItem(995, 250000), new GameItem(6199, 2)),
       ...
       Fishing_Task_I(6, AchievementTier.TIER_1, AchievementType.FISH, null, "Catch 1000 Fish", 1000, 1, new GameItem(995, 250000), new GameItem(384, 500), new GameItem(20791, 2)),
        ...
        INTERMEDIATE_FARMER(8, AchievementTier.TIER_2, AchievementType.FARM, null, "Pick Herbs 300 Times", 300, 2, new GameItem(995, 750000), new GameItem(3052, 300), new GameItem(13640), new GameItem(20791, 2)),
        ...
        EXPERT_FARMER(8, AchievementTier.TIER_3, AchievementType.FARM, null, "Pick Herbs 600 Times", 600, 3, new GameItem(995, 1000000), new GameItem(220, 500), new GameItem(13642), new GameItem(20791, 2)),
