...
public class Region {
	...
	private static final WorldObject[] EXISTANT_OBJECTS = { 
			...
			new WorldObject(29878, 3095, 3510, 0, 1),
			new WorldObject(172, 3084, 3490, 0, 1), new WorldObject(6150, 3105, 3502, 0, 3), 
			new WorldObject(6150, 3105, 3502, 0, 3), new WorldObject(6150, 3107, 3502, 0, 3),
			new WorldObject(24600, 3091, 3492, 0, 0), new WorldObject(158, 3084, 3513, 0, 2), 
			//new WorldObject(409, 3085, 3510, 0, 1), new WorldObject(412, 3092, 3506, 0, 2),
			//new WorldObject(6552, 3094, 3506, 0, 2), new WorldObject(26645, 3099, 3491, 0, 1),
			// Kbd gates
			...
			new WorldObject(2030, 2856, 2967, 0, 1), //furnace
	...
	public static boolean isWorldObject(int id, int x, int y, int height) {
		...
		return regionObjects.stream().anyMatch(object -> object.id == id && object.x == x && object.y == y && object.height == height % 4);
	}
	...
	public static boolean solidObjectExists(int x, int y, int height) {
		...
		Optional<WorldObject> exists = regionObjects.stream().filter(object -> object.x == x && object.y == y && object.height == (height % 4)).findFirst();
	...
	public static Optional<WorldObject> getWorldObject(int id, int x, int y, int height) {
		...
		Optional<WorldObject> exists = regionObjects.stream().filter(object -> object.id == id && object.x == x && object.y == y && object.height == (height % 4)).findFirst();
		return exists;
	}
