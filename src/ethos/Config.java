...
public class Config {
	...
	/**
	 * The highest amount ID. Change is not needed here unless loading items higher than the 667 revision.
	 */
	public static final int ITEM_LIMIT = 30_000;
	 ...
	 */
	public static final int[] ITEM_SELLABLE = { 995, 19730, 12020, 6713, 13307, 12013, 12014, 12015, 12016, 20008, 776, 10071, 13258, 132259,
	 ...
	 */
	public static final int[] NOT_SHAREABLE = { 13258, 13259, 13260, 13261, 19730, 12020, 6713, 13307, 12013, 10071,
			...
			12926, 12931, 12785, 12954, 15573, 8135, 11865, 11864, 12373, 12379, 12369, 12367, 12365, 12363, 10507,
			...
			12323, 12325, 12516, 21043, 19675 ,21273,21197};
	/**
	 * Items that are kepts on death
	 */
	public static final int[] ITEMS_KEPT_ON_DEATH = { 6713, 13307, 12013, 10071, 12014, 12015, 12016, 20008, 776, 13258,
			...
			11919, 12956, 12957, 12958, 12959, 12785, 12954, 15573, 8135, 11864, 11865, 12432, 12373, 12379, 12369,
			...
			12856, 13274, 13275, 13276, 19675, 20792, 20794, 20796 };
	/**
	...
	public static final int[] DROP_AND_DELETE_ON_DEATH = { 9748, 9754, 9751, 9769, 9757, 9760, 9763, 9802, 9808, 9784,
			...
			5733, 12791, 5509, 5510, 5512, 11849, 13069, 13070, 6822, 6824, 6826, 6828, 6830, 6832, 6834, 6836, 6838,
	...
	public static final int[] UNDROPPABLE_ITEMS = { 6713, 19841, 11941, 12791, 11919, 12956, 12957, 12958, 12959, 12899, 11907, 12432,
			12369, 12367, 12365, 12363, 6822, 6824, 6826, 6828, 6830, 6832, 6834, 6836, 6838, 6840, 6842,
			6844, 6846, 6848, 6850, 19675 };
	 ...
	 */
	public static final String[] UNSPAWNABLE = { "ahrim", "reindeer", "star bauble", "bauble", "torag", "dharok", "overload", "tenderiser", "woolly", "bobble", "jester", "gilded",
			"legend", "hell", "dragon spear", "odium", "malediction", "callisto", "gods", "yrannical", "treasonous", "granite maul", "ancient mace", "super combat",
			"dragon halberd", "torstol", "d hally", "dragon hally", "karil", "defender icon", "attacker icon", "picture", "collector icon", "collecter icon", "healer icon",
			"crystal key", "essence", "3rd", "third", "bomb", "karamb", "guthan", "verac", "void", "uncut", "Restrict", "onyx amulet", "onyx ring", "spirit", "chisel", "statius",
			"vesta", "morrigan", "zuriel", "occult", "trident", "mystic smoke", "mystic steam", "tentacle", "dark bow", "ranger boots", "robin hood hat", "attack cape",
			"defence cape", "strength cape", "prayer cape", "constitution", "range cape", "ranged cape", "ranging cape", "magic cape", "herblore", "agility", "fletching",
			"crafting", "runecrafting", "runecraft", "farming", "hunter", "slayer", "summoning", "construction", "woodcutting", "firemaking", "fishing", "cooking", "smithing",
			"mining", "thieving", "arcane", "divine", "spectral", "wealth", "elysian", "spirit", "status", "hand cannon", "visage", "raw", "logs", "bar", "ore", "uncut",
			"dragon leather", "scroll", "hatchet", "iron axe", "steel axe", "bronze axe", "rune axe", "adamant axe", "mithril axe", "black axe", "dragon axe", "vesta", "pumpkin",
			"statius's", "zuriel", "morrigan", "dwarven", "statius", "fancy", "rubber", "sled", "flippers", "camo", "lederhosen", "mime", "lantern", "santa", "scythe", "bunny",
			"h'ween", "hween", "clue", "casket", "cash", "box", "cracker", "zuriel's", "Statius's", "torso", "fighter", "Statius", "skeleton", "chicken", "zamorak platebody",
			"guthix platebody", "saradomin plate", "grim reaper hood", "armadyl", "bandos", "armadyl cross", "graardor", "zilyana", "kree", "tsut", "mole", "kraken", "dagannoth",
			"king black dragon", "chaos ele", "staff of the dead", "staff of dead", "(i)", "ticket", "PK Point", "jester", "dragon defender", "fury", "mithril defender",
			"adamant defender", "rune defender", "elysian", "mystery box", "arcane", "chaotic", "Chaotic", "stream", "broken", "deg", "corrupt", "fire cape", "sigil", "godsword",
			"void seal", "lunar", "hilt", "(g)", "mage's book", "berserker ring", "warriors ring", "warrior ring", "warrior's ring", "archer", "archer's ring", "archer ring",
			"archers' ring", "seers' ring", "seer's ring", "seers ring", "mages' book", "wand", "(t)", "guthix", "zamorak", "saradomin", "scythe", "bunny ears", "zaryte bow",
			"armadyl battlestaff", "(i)", "infinity", "slayer", "korasi", "staff of light", "dice", "ardougne", "unarmed", "gloves", "dragon claws", "party", "santa",
			"completionist", "null", "coins", "Kaodai", "Elder", "tokhaar-kal", "tokhaar", "sanfew", "dragon defender", "zaryte", "coupon", "flippers", "dragonfire shield", "sled", };
	...
	/**
	 * The time, in game cycles that the skull above a player should exist for. Every game cycle is 600ms, every minute has 60 seconds. Therefor there are 100 cycles in 1 minute.
	 * .600 * 100 = 60.
	 */
	 ...
	 */
	public static final String[] SKILL_NAME = { "Attack", "Defence", "Strength", "Hitpoints", "Ranged", "Prayer", "Magic", "Cooking", "Woodcutting", "Fletching", "Fishing",
	...
	/**
	 * Bonus modes
	 * Manually set while server is live
	 */
	 ...
	 */
	public static final int START_LOCATION_X = 1502;
	public static final int START_LOCATION_Y = 3629;

	/**
	 * The re-spawn point of when someone dies.
	 */
	public static final int RESPAWN_X = 1502;
	public static final int RESPAWN_Y = 3629;
 ...
 * Glory locations.
	...
	public static final int HERBLORE_EXPERIENCE = 13;
	public static final int FISHING_EXPERIENCE = 43;
	...
	public static final int COOKING_EXPERIENCE = 34;
	 ...
	 * Wolf's variables
	 */
	public static final int MaxBonesAltar = 50;
	public static final int MiningGuildReq = 60;
	public static final int MaxFish = 50;
